package game
{
   ...
   public class §&!K§
   {
      ...
      public var §=F§:TunnelLayout3D;
      
      public var §^$§:Game;
      
      public var §43§:§=!U§;
      
      public function §&!K§(param1:Game, param2:String)
      {
         §§push(false);
            ...
            while(true)
            {
               if(!_loc32_)
               {
                  ...
                  if(§§pop())
                  {
                     ...
                     _loc5_ = §§pop().parseSpec(§§pop());
                     if(!_loc32_)
                     {
                        if(_loc5_ is TunnelLayout3D)
                        {
                           if(_loc31_)
                           {
                              §=F§ = _loc5_;
      ...
      public function §`!>§(param1:int, param2:§>f§) : void
      {
         ...
         var _loc14_:* = null as Quaternion;
         ...
         while(true)
         {
            while(true)
            {
               ...
               if(§&!K§.§#-§.rotation != null)
               {
                  ...
                  QuaternionUtils.multiply(§&!K§.§#-§.rotation,_loc11_.transform.§,t§,_loc11_.transform.§,t§);
               }
               _loc11_.reset();
               break;
            }
