package game
{
   ...
   public class Game extends Level
   {
      ...
      public static var §9!a§:Quaternion;
      ...
      public static var §[@§:Quaternion = _loc3_;
      ...
      public var §!!@§:Vector.<Entity3D>;
      
      public var §<!>§:Boolean;
      
      public var §+!_§:Boolean;
      
      public function Game(param1:String, param2:String)
      {
         var _temp_1:* = true;
         ...
         var _loc23_:* = null as Quaternion;
         var _loc24_:* = NaN;
         var _loc25_:* = NaN;
         ...
         var _loc5_:Vector.<Entity3D> = new Vector.<Entity3D>(0,false);
         loop5:
         while(true)
         {
            if(!_loc34_)
         ...
         var _loc16_:Quaternion = new Quaternion();
         loop9:
         while(true)
         {
            while(true)
            ...
            while(_loc8_ < _loc19_)
            {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     _loc18_ = §§pop()[§§pop()];
                     QuaternionUtils.rotateVector(_loc16_,_loc15_,_loc14_);
                     if(!_loc34_)
                     {
                        _loc14_.x += _loc17_.x;
                        while(true)
         ...
         if(!_loc11_)
         {
            if(param1)
            {
               if(_loc12_)
               {
                  ...
                  var _loc4_:Quaternion = §&!b§;
                  var _loc5_:Quaternion = camera.getRotation();
                  loop4:
                  while(true)
                  {
                     while(true)
                        ...
                        while(true)
                        {
                           while(true)
                           {
                              ...
                              else
                              {
                                 ...
                                 if(§§pop() >= §§pop())
                                 {
                                    QuaternionUtils.multiply(§3!3§,Game.§[@§,§3!3§);
                                    break;
                                 }
                              }
                              QuaternionUtils.multiply(§3!3§,Game.§9!a§,§3!3§);
                              if(_loc12_)
                              {
                                 break;
                              }
      ...
      override public function update(param1:Number) : void
      {
         ...
         Game.controlScheme.update(param1);
         while(true)
         {
                              ...
                              else
                              {
                                 ...
                                 while(true)
                                 {
                                    ...
                                    while(true)
                                    {
                                       ...
                                       if(!_loc3_)
                                       {
                                          §7!O§.§=d§(§?!_§.§=F§.getPosition(_loc2_,Game.§5o§),10);
                                          §7!O§.reset();
                                       }
                                       break;
                                    }
      ...
      public function §^y§(param1:Number) : void
      {
         ...
         var _loc3_:Quaternion = §&!b§;
         var _loc4_:Quaternion = camera.getRotation();
         while(true)
         {
            if(!_loc10_)
            {
               ...
               while(true)
               {
                  while(true)
                  {
                     if(!_loc7_)
                     {
                        if(§8!5§ >= int(§!!@§.length))
                        {
                           _loc4_ = new Entity3D(this,false,new §[O§(_loc3_,§[D§.§7!P§()));
                           if(!_loc7_)
                           {
                              §`=§(_loc4_);
                              if(_loc7_)
      ...
      override public function display(param1:Number) : void
      {
         ...
         var _loc2_:Point3D = camera.getPosition();
         while(true)
         {
            loop4:
            while(true)
                                    ...
                                    else
                                    {
                                       ...
                                       while(true)
                                       {
                                          while(true)
                                          {
                                             if(_loc17_)
                                             {
                                                QuaternionUtils.slerp(§&!b§,§3!3§,_loc3_,_loc4_);
                                                camera.setRotation(_loc4_);
                                                §§push(§!6§);
                                                if(!_loc16_)
                                                {
                                                   §§push(Number(§§pop()));
               ...
               if(_loc17_)
               {
                  ...
                  if(_loc2_.x == camera.position.x)
                  {
                     while(true)
                     {
                        ...
                        {
                           §§pop();
                           §§push(_loc2_.y == camera.position.y);
                           if(_loc17_)
                           {
                              §§push(!§§pop());
                              if(!_loc17_)
                  ...
                  §§pop();
                  §§push(_loc2_.z == camera.position.z);
               }
               addr0642:
               §§push(!§§pop());
               if(!_loc16_)
...
QuaternionUtils.multiply(_loc7_,_loc9_,Game.§[@§);
