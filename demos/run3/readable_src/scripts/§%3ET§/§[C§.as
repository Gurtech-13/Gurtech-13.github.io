package §>T§
{
   ...
   public class §[C§ extends Entity3D
   {
      ...
      public static function §4r§(param1:Level, param2:§0!E§) : §[C§
      {
         var _temp_1:* = false;
      ...
      public function §]2§(param1:Level, param2:§0!E§) : void
      {
         var _temp_1:* = true;
      ...
      public function §=d§(param1:PositionData3D, param2:Number) : void
      {
         ...
         {
            QuaternionUtils.multiply(param1.rotation,transform.§,t§,transform.§,t§);
         }
      }
      ...
      public function §,W§(param1:PositionData3D, param2:TunnelSection) : void
      {
         ...
         var _loc3_:Level = param2.tunnel;
         if(§4!5§ == §-n§.§?!W§)
         {
            _loc4_ = §@p§.§4!W§;
            if(_loc3_.backwards)
            ...
            if((§§pop() >= §§pop() ? _loc5_ : -_loc5_) >= 1e-10)
            {
               ...
               if(param1.rotation != null)
               {
                  QuaternionUtils.multiply(param1.rotation,§[C§.§7!U§,§[C§.§7!U§);
               }
               QuaternionUtils.rotateVector(§[C§.§7!U§,§[C§.§1]§,§[C§.§1]§);
               if(_loc3_.backwards)
               {
                  §[C§.§1]§.z = -§[C§.§1]§.z;
               }
      ...
      public function §=y§(param1:TunnelSection, param2:int) : void
      {
         ...
         var _loc4_:* = §§pop();
         var _loc5_:* = null as TunnelLayout3D;
         §§push(0);
         if(_loc17_)
         {
            §§push(-§§pop() - 9 - 7 - 1);
         ...
         var _loc13_:* = null as Quaternion;
         ...
         if(§§pop())
         {
            ...
            _loc4_ = int(§§pop());
            if(param1.layout is TunnelLayout3D)
            {
