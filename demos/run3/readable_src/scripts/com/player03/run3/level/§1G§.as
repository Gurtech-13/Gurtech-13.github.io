package com.player03.run3.level
{
   ...
   public class §1G§
   {
      ...
      public function §1G§(param1:CharacterBase = undefined)
      {
         §§push(false);
      ...
      public function §-K§(param1:CharacterBase) : void
      {
         §§push(false);
         var _loc5_:Boolean = true;
         var _loc6_:* = §§pop();
         var _loc2_:Level = param1.tunnel;
         if(!_loc6_)
         {
            if(param1.§73§ != null)
            {
               if(!_loc6_)
               {
                  ...
                  {
                     addr0082:
                     section = _loc2_.§]!#§(param1.transform.position.z,false);
                  }
               }
               else
               {
            ...
            {
               section = _loc2_.§]!#§(param1.transform.position.z,true);
               if(_loc5_)
               {
                  §§goto(addr0063);
               }
