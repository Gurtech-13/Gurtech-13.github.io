package com.player03.run3.level
{
   ...
   public class §-p§ extends Object3D
   {
      
      public static var §-6§:Boolean;
      
      public static var §!!A§:Object3D;
      ...
      public function §-p§(param1:LevelView)
      {
         var _temp_1:* = true;
         ...
         while(true)
         {
            ...
            if(_loc20_)
            {
               while(_loc13_ < int(_loc7_.length))
               {
                  ...
                  QuaternionUtils.rotateVector(_loc12_,_loc14_,_loc14_);
               }
            }
            §§push([QuaternionUtils.fromAxes(_loc2_,_loc5_),QuaternionUtils.fromAxes(_loc4_,_loc5_),QuaternionUtils.fromAxes(_loc1_,_loc5_),QuaternionUtils.fromAxes(_loc6_,_loc3_),QuaternionUtils.fromAxes(_loc5_,_loc4_),QuaternionUtils.fromAxes(_loc3_,_loc5_)]);
            if(!_loc19_)
            {
               §§push(§§pop());
            }
            var _loc15_:* = §§pop();
            var _loc16_:Vector.<Quaternion> = Vector.<Quaternion>(_loc15_);
            loop11:
            while(true)
            {
               if(!_loc19_)
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           if(!_loc19_)
                           {
                              ...
                              if(!_loc19_)
                              {
                                 _loc18_.transform.setRotation(_loc16_[_loc17_]);
                                 if(_loc19_)
                                 {
                                    continue loop1;
                                 }
         ...
         while(true)
         {
            ...
            while(true)
            {
               if(§§pop())
               {
                  ...
                  _loc4_ = §6s§.transform.getPosition();
                  loop4:
                  while(true)
                  {
                     if(_loc9_)
