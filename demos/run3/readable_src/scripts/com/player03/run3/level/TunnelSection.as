package com.player03.run3.level
{
   ...
   public class TunnelSection implements §[!M§
   {
      ...
      public function TunnelSection(param1:Level, param2:Scene3D, param3:Vector.<Entity3D>, param4:String, param5:int, param6:Number, param7:Object = undefined, param8:Object = undefined, param9:Object = undefined, param10:Object = undefined)
      {
         /*
          * Decompilation error
      ...
      public static function §]d§(param1:Array, param2:Level = undefined) : Boolean
      {
         var _temp_1:* = true;
      ...
      public static function checkCondition2(param1:String, param2:Level = undefined) : int
      {
         var _temp_1:* = true;
      ...
      public function §-x§(param1:CharacterDef) : Boolean
      {
         var _temp_1:* = true;
      ...
      public function §%f§(param1:CharacterDef) : Boolean
      {
         §§push(false);
      ...
      public function getPosition(param1:int, param2:PositionData3D = undefined) : PositionData3D
      {
         ...
         param2 = layout.getPosition(param1,param2);
      ...
      public function getIndexNearest(param1:Point3D) : int
      {
         ...
         §§push(layout.getIndexNearest(param1));
         if(!_loc5_)
         {
            return int(§§pop());
         }
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     if(!_loc7_)
                     {
                        while(true)
                        {
                           §§push(layout.getRelativeIndex(0,0,0,1));
                           if(!_loc7_)
                           {
                              _loc2_ = §§pop();
