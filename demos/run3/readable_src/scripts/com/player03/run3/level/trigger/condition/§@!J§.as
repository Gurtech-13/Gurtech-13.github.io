package com.player03.run3.level.trigger.condition
{
   ...
   public class §@!J§
   {
      ...
      public static function §@&§(param1:int) : §#!G§
      {
         return new §=o§(param1,function(param1:Level):int
         {
      ...
      public static function §8!S§(param1:Number) : §#!G§
      {
         ...
         return new §#!G§(function(param1:Level):Number
         {
            var _temp_1:* = true;
      ...
      {
         return new §+d§(param1,function(param1:Level):int
         {
            return param1.characters[0].§73§.tilesDislodged;
         });
      }
      ...
      public static function §9o§(param1:Number) : §#!G§
      {
         ...
         return new §,!8§(function(param1:Level):Number
         {
            var _temp_1:* = true;
            var _loc8_:Boolean = false;
            var _loc9_:Boolean = _temp_1;
      ...
      public static function §<!H§(param1:String) : §#!G§
      {
         ...
         return new §1S§(function(param1:Level):Number
         {
            var _temp_1:* = true;
            var _loc2_:Boolean = false;
            var _loc3_:Boolean = _temp_1;
      ...
      public static function §`!`§(param1:int) : §#!G§
      {
         ...
         var _loc2_:§#!G§ = new §#!G§(function(param1:Level):Number
         {
            var _temp_1:* = false;
            var _loc5_:Boolean = true;
            var _loc6_:Boolean = _temp_1;
            var _loc4_:* = null as CharacterBase;
            §§push(0);
            if(!_loc6_)
            {
               §§push(int(§§pop()));
            ...
            var _loc2_:* = §§pop();
            var _loc3_:Vector.<CharacterBase> = param1.characters;
            if(_loc5_)
            {
               loop0:
