package com.player03.run3.level
{
   ...
   public class LevelView extends Object3D
   {
      ...
      public var §<!3§:AxisAngle;
      
      public var camera:Transform;
      
      public function LevelView(param1:Scene3D, param2:Transform)
      {
         var _temp_1:* = true;
      ...
      override public function §%!B§(param1:§4!V§, param2:Boolean) : void
      {
         ...
         if(!_loc8_)
         {
            QuaternionUtils.toAxisAngle(camera.getRotation(),§<!3§);
            if(_loc7_)
            {
               var _temp_1:* = §<!3§;
               §§push(_temp_1);
            ...
            if(_loc7_)
            {
               while(_loc3_ < int(_loc4_.length))
               {
                  ...
                  while(true)
                  {
                     ...
                     addr01c6:
                     LevelView.§9!Y§.§%V§(§<!3§.angle,§<!3§);
                     break;
                  }
                  _loc6_ = LevelView.§9!Y§;
                  if(!_loc8_)
                  {
                     Matrix3D.multiplyInto(_loc6_.rawData,§"[§.§-4§.rawData,_loc6_.rawData);
                     if(_loc7_)
                     {
