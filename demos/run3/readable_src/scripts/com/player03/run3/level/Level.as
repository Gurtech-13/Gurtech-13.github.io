package com.player03.run3.level
{
   ...
   public class Level extends World
   {
      ...
      public var characters:Vector.<CharacterBase>;
      
      public var §4-§:Quaternion;
      ...
      public function Level(param1:int, param2:§1!&§, param3:§,a§, param4:Object = undefined)
      {
         var problemSection:TunnelSection;
         var rejectedCharacter:CharacterDef;
         var _gthis:Level;
         var _temp_1:* = true;
         var _loc18_:Boolean = false;
         var _loc19_:Boolean = _temp_1;
         var _loc11_:* = null as CharacterDef;
         var _loc12_:* = null as CharacterBase;
         var _loc13_:* = 0;
         ...
         var _loc5_:Scene3D = new Scene3D();
         _loc5_.§9!R§ = new § !X§();
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           while(true)
                           {
                              ...
                              param4.character = CharacterRegistry.§3'§(param4.characterByName);
                              if(!_loc18_)
                              {
                                 break loop27;
                              }
         ...
         var _loc6_:Point3D = Level.§7!,§;
         if(!_loc18_)
         {
            §%K§ = new Point3D(_loc6_.x,_loc6_.y,_loc6_.z);
         }
         var _loc7_:Point3D = Level.§7!,§;
         loop7:
         while(true)
         {
            if(_loc19_)
         ...
         var _loc10_:Vector.<CharacterBase> = new Vector.<CharacterBase>(0,false);
         loop10:
         while(true)
         {
            loop11:
                                 ...
                                 if(§§pop())
                                 {
                                    if(!_loc18_)
                                    {
                                       ...
                                       while(true)
                                       {
                                          while(true)
                                          {
                                             if(§7!E§ != null)
                                             {
                                                ...
                                                addr0513:
                                                CharacterRegistry.random.§4!a§(§1W§.charactersAllowed);
                                                if(_loc18_)
                                                {
                                                   break loop17;
                                                }
                                             }
                                             else if(_loc11_ == CharacterRegistry.random && Boolean(param4.randomizeOnStart))
                                             {
                                                §§goto(addr0513);
                                             }
                                       ...
                                       if(_loc11_.§#U§)
                                       {
                                          ...
                                          _loc14_ = CharacterRegistry.available;
                                          if(_loc19_)
                                          {
                                             loop0:
                           ...
                           if(!_loc8_)
                           {
                              if(_loc5_ != null)
                              {
                                 ...
                                 while(true)
                                 {
                                    ...
                                    victoryCondition = function(param1:CharacterBase):Boolean
                                    {
      ...
      public function §<§(param1:CharacterBase) : void
      {
         var _gthis:Level;
         var _temp_1:* = true;
                  ...
                  if(§§pop())
                  {
                     ...
                     while(true)
                     {
                        if(_loc7_)
                        {
                           ...
                           if(param1.§!8§ == CharacterRegistry.random)
                           {
                              §2d§();
                           }
                           else
                           {
                              ...
                              while(true)
                              {
                                 if(_loc7_)
                                 {
                                          ...
                                          while(true)
                                          {
                                             while(true)
                                             {
                                                while(true)
                                                {
                                                   ...
                                                   §§push(int(CharacterRegistry.available.length));
                                                   break;
                                                }
                                                if(§§pop() >= §§pop())
                                                {
                                             ...
                                             while(true)
                                             {
                                                ...
                                                while(true)
                                                {
                                                   ...
                                                   while(true)
                                                   {
                                                      while(true)
                                                      {
                                                         ...
                                                         if(_loc7_)
                                                         {
                                                            ...
                                                            §§push(CharacterRegistry.available[_loc3_].§<!,§());
                                                            if(_loc7_)
                                                            {
                                                               §§push(Boolean(§§pop()));
                                                            }
                                                         ...
                                                         §§push(CharacterRegistry.available[_loc3_].§#U§);
                                                         if(!_loc6_)
                                                         {
                                                            break loop12;
                                                         }
                                                   ...
                                                   if(§§pop())
                                                   {
                                                      ...
                                                      {
                                                         §§pop();
                                                         §§push(CharacterRegistry.available[_loc3_] == CharacterRegistry.random);
                                                         if(_loc7_)
                                                         {
                                                            break loop11;
                                                         }
                                    ...
                                    {
                                       §§pop();
                                       §§push(_loc2_ == null || _loc2_.§%f§(CharacterRegistry.available[_loc3_]));
                                    }, !§§pop());
                                 }
                                 CharacterRegistry.§3§(CharacterRegistry.available[_loc3_]);
                                 break;
                              }
                           }
                        }
      ...
      public function §+,§(param1:CharacterDef) : CharacterBase
      {
         §§push(false);
         var _loc7_:Boolean = true;
         var _loc8_:* = §§pop();
               ...
               if(!§§pop())
               {
                  if(!_loc8_)
                  {
                     ...
                     if(!_loc8_)
                     {
                        ...
                        if(!_loc8_)
                        {
                           while(true)
                           {
                              ...
                              if(param1 == CharacterRegistry.random)
                              {
                                 if(!_loc8_)
                                 {
                                    CharacterRegistry.random.§4!a§(_loc2_.charactersAllowed);
                                    if(_loc7_)
                                    {
                                       break;
                                    }
                        ...
                        var _loc4_:* = §§pop();
                        var _loc5_:Vector.<CharacterBase> = characters;
                        while(true)
                        {
                           if(!_loc8_)
                           {
      ...
      public function §>j§() : void
      {
         ...
         var _loc1_:* = §§pop();
         var _loc2_:Vector.<CharacterBase> = characters;
         if(_loc4_)
         {
                  ...
                  if(int(characters.length) > 0)
                  {
                     ...
                     if(!_loc6_)
                     {
                        ...
                        while(true)
                        {
                           ...
                           _loc1_ = §'!U§;
                           _loc2_ = characters[0].transform.§=0§.getRotation();
                           while(true)
                           {
                              if(_loc5_)
                              {
      ...
      public function §5h§(param1:CharacterBase) : void
      {
         var _temp_1:* = true;
         var _loc6_:Boolean = false;
         var _loc7_:Boolean = _temp_1;
      ...
      public function §<L§(param1:int) : void
      {
         ...
         var _loc9_:* = false;
         var _loc11_:* = 0;
         var _loc12_:* = null as Vector.<CharacterDef>;
         var _loc13_:* = null as CharacterDef;
         if(!_loc14_)
         {
            if(§?!I§ == null)
            {
         ...
         var _loc2_:Scene3D = scene;
         var _loc3_:Vector.<Entity3D> = §<!7§;
         while(true)
         {
            if(!_loc14_)
            {
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        ...
                        if(§§pop())
                        {
                           ...
                           _loc12_ = CharacterRegistry.available;
                           loop9:
                           while(true)
                           {
                              loop10:
      ...
      public function §5!M§(param1:CharacterBase) : Boolean
      {
         var _temp_1:* = true;
            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     ...
                     addr01c9:
                     _loc6_ = _loc2_.transform.§=0§.getRotation();
                     _loc7_ = §'!U§;
                     loop25:
                     while(true)
                     {
                     ...
                     while(true)
                     {
                        ...
                        if(!_loc34_)
                        {
                           QuaternionUtils.rotateVector(§'!U§,§3A§,Level.§!+§);
                        }
                        _loc14_ = Level.§!+§;
                        _loc15_ = _loc13_;
                        if(_loc15_ == null)
                              ...
                              if(§--§)
                              {
                                 if(!_loc34_)
                                 {
                                    ...
                                    if(_loc16_ != null)
                                    {
                                       ...
                                       if(_loc33_)
                                       {
                                          _loc17_.moveInside(_loc13_,60,World.§1]§);
                                       }
                                       _loc14_ = World.§1]§;
                                       while(true)
                                       {
                                       ...
                                       while(true)
                                       {
                                          ...
                                          while(true)
                                          {
                                             ...
                                             addr07cd:
                                             QuaternionUtils.rotateVector(camera.getRotation(),Level.§7K§,Level.§7K§);
                                             addr07e8:
                                             _loc15_ = World.§1]§;
                                             _loc21_ = World.§1]§;
                                             loop45:
      ...
      public function §5!Y§(param1:int) : void
      {
         ...
         var _loc13_:* = null as CharacterBase;
         if(_loc14_)
         {
            § L§.high = 38910;
            if(_loc14_)
         ...
         addr0310:
         var _loc12_:Vector.<CharacterBase> = characters;
         while(true)
         {
            if(!_loc15_)
            {
                     ...
                     while(true)
                     {
                        ...
                        if(_loc12_)
                        {
                           while(true)
                           {
                              ...
                              if(_loc12_)
                              {
                                 if(_loc6_.endZ >= camera.position.z)
                                 {
                                    break;
                                 }
                                 if(!_loc12_)
                              ...
                              if(!_loc13_)
                              {
                                 §§push(_loc6_.endZ >= §73§.startZ + Level.§7!,§.z);
                                 if(_loc12_)
                                 {
                                    §§push(Boolean(§§pop()));
                                 }
                                 ...
                                 if(!_loc13_)
                                 {
                                    ...
                                    while(true)
                                    {
                                       while(true)
                                       {
                                          ...
                                          if(_loc12_)
                                          {
                                             if(_loc8_.endZ >= camera.position.z)
                                             {
                                                break loop10;
                                             }
                                             if(_loc13_)
                                             ...
                                             §§push(_loc8_.endZ >= §73§.startZ + Level.§7!,§.z);
                                             if(!_loc12_)
                                             {
                                                break loop10;
                                             }
