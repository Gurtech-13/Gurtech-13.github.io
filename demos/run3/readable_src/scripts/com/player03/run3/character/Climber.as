package com.player03.run3.character
{
   ...
   public class Climber extends CharacterBase
   {
      ...
      public function Climber(param1:Level, param2:CharacterDef)
      {
         §§push(false);
      ...
      public static function §1L§(param1:Entity3D, param2:Point3D, param3:Number) : Boolean
      {
         var _temp_1:* = true;
         ...
         if(_loc13_)
         {
            ...
            if(param1.transform.§=0§ != null)
            {
               if(_loc13_)
               {
                  QuaternionUtils.rotateVector(param1.transform.§=0§.§<!A§(),Climber.§1]§,Climber.§1]§);
               }
            }
                  ...
                  while(true)
                  {
                     ...
                     if(!_loc14_)
                     {
                        ...
                        if(§-X§.§"!G§ == this)
                        {
                              ...
                              if(§§pop())
                              {
                                 while(true)
                                 {
                                    ...
                                    if(§§pop())
                                    {
                                       ...
                                       QuaternionUtils.rotateVector(transform.§=0§.§+n§(),Climber.up,Climber.up);
                                       §§goto(addr0906);
                                    }
                                    else
                                    {
                           ...
                           if(_loc15_)
                           {
                              QuaternionUtils.rotateVector(transform.§=0§.§+n§(),Climber.§1]§,Climber.§1]§);
                              §-X§.§@!$§(null);
                           }
                           §-X§.sticky = true;
                           if(_loc15_)
                                    ...
                                    while(true)
                                    {
                                       while(true)
                                       {
                                          ...
                                          if(!_loc14_)
                                          {
                                             ...
                                             target = null;
                                             bestDistanceSq = 3600;
                                             tunnel.§06§(§6X§,function(param1:Entity3D):void
                                             {
                                                var _temp_1:* = false;
                                                var _loc3_:Boolean = true;
      ...
      public function §&,§(param1:Entity3D) : Boolean
      {
         var _temp_1:* = true;
            ...
            while(true)
            {
               if(!_loc8_)
               {
                  ...
                  if(!_loc8_)
                  {
                     if(!param2)
                     {
                        QuaternionUtils.rotateVector(transform.§=0§.§+n§(),param1,Climber.§1]§);
                        if(_loc7_)
                        {
                           break loop0;
                        }
