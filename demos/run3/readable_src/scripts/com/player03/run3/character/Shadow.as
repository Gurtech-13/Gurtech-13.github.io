package com.player03.run3.character
{
   ...
   public class Shadow extends Entity3D
   {
      ...
      public static var §^f§:Quaternion;
      
      public static var §1Z§:§'H§;
      
      public static var §^!K§:int;
      
      public var § S§:Quaternion;
      ...
      public function Shadow(param1:World, param2:CharacterBase, param3:Number, param4:Shadow = undefined)
      {
         §§push(false);
         ...
         if(!_loc12_)
         {
            while(true)
            {
               ...
               if(§§pop() <= §§pop())
               {
                  ...
                  if(_loc11_)
                  {
                     QuaternionUtils.rotateVector(§^z§,p1Offset,p1Offset);
                  }
                  addr050d:
                  _loc2_ = p2Offset;
                  while(true)
                  ...
                  if(!_loc12_)
                  {
                     QuaternionUtils.rotateVector(§^z§,p2Offset,p2Offset);
                  }
                  addr0563:
                  return;
               }
      ...
      override public function display(param1:Number) : void
      {
         ...
         var _loc11_:* = false;
         var _loc12_:* = null as Quaternion;
         ...
         if(!_loc18_)
         {
            while(true)
            {
               ...
               var _loc7_:Quaternion = transform.§+n§();
               var _loc8_:Entity3D = §!C§.§1%§(p1,p2,§-'§,_loc2_,0,null,_loc7_);
               if(_loc17_)
               {
                  while(true)
                  {
                     ...
                     {
                        QuaternionUtils.multiply(_loc7_,Shadow.§^f§,_loc7_);
                        if(!_loc18_)
                        {
                           §§goto(addr0303);
                        }
