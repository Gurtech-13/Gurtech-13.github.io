package com.player03.run3.character
{
   ...
   public class §7!I§ extends Entity3D
   {
      
      public var §"!G§:Entity3D;
      ...
      public function §7!I§(param1:World, param2:Transform = undefined)
      {
         §§push(false);
            ...
            if(!_loc12_)
            {
               ...
               if(!_loc12_)
               {
                  ...
                  if(!_loc12_)
                  {
                     if(§>!R§ != null)
                     {
                        QuaternionUtils.rotateVector(§>!R§.§+n§(),§[!G§.§#!Q§,§[!G§.§#!Q§);
                     }
                  }
               }
            }
      ...
      public function §@!$§(param1:Entity3D) : Entity3D
      {
         §§push(false);
      ...
      public function §%B§(param1:Entity3D) : Boolean
      {
         §§push(false);
      ...
      public function §]!O§(param1:Entity3D, param2:Point3D) : Boolean
      {
         §§push(false);
      ...
      public function §0c§(param1:Entity3D) : void
      {
         var _temp_1:* = true;
