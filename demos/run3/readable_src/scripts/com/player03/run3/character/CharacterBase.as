package com.player03.run3.character
{
   ...
   public class CharacterBase extends Entity3D implements IEventDispatcher, §<!1§
   {
      ...
      public static var §"m§:Quaternion;
      ...
      public function CharacterBase(param1:Level, param2:CharacterDef)
      {
         var _temp_1:* = true;
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(!_loc12_)
               {
                  ...
                  §§pop().spritesheet = new §§pop().Spritesheet(§§pop(),null,0.45681063122923593,0,-1.5,null,null,§1r§());
      ...
      public function §29§() : void
      {
         ...
         var _loc2_:* = §§pop();
         var _loc3_:Quaternion = CharacterBase.§"m§;
         while(true)
         {
            if(_loc8_)
            {
      ...
      public function §+!^§(param1:Number) : Number
      {
         ...
         var _loc2_:Quaternion = transform.§+n§();
      ...
      public function §0e§(param1:Entity3D) : Boolean
      {
         var _temp_1:* = true;
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = _temp_1;
            ...
            if(!_loc4_)
            {
               while(true)
               {
                  ...
                  if(§#[§.active)
                  {
                     ...
                     if(!_loc4_)
                     {
                        _loc2_.§"@§.tunnel.§%K§.y = Level.§7!,§.y * 0.4;
                        if(_loc3_)
                        {
      ...
      public function §%9§(param1:Entity3D, param2:Point3D) : Boolean
      {
         §§push(false);
                     ...
                     if(§§pop())
                     {
                        ...
                        else
                        {
                           ...
                           while(true)
                           {
                              ...
                              QuaternionUtils.rotateVector(_loc7_,_loc6_,_loc6_);
                              break;
                           }
                        }
                        loop22:
