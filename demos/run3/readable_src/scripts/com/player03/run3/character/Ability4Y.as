package com.player03.run3.character
{
   ...
   public class Ability4Y extends §'5§
   {
      ...
      public function Ability4Y(param1:CharacterBase, param2:Number, param3:Number, param4:Number, param5:Number = 0)
      {
         var _temp_1:* = true;
