package com.player03.run3.character
{
   ...
   public class Duplicator extends CharacterBase
   {
      ...
      public function Duplicator(param1:Level, param2:CharacterDef)
      {
         §§push(false);
      ...
      public function §^w§(param1:Entity3D) : Boolean
      {
      ...
      override public function display(param1:Number) : void
      {
         ...
         var _loc17_:* = 0;
         var _loc18_:int = 0;
         var _loc19_:* = null as CharacterBase;
      ...
      override public function §=5§(param1:§[C§, param2:Point3D, param3:Point3D) : Boolean
      {
         ...
         var _loc4_:* = §§pop();
         var _loc5_:CharacterBase = tunnel.characters[0];
         loop1:
         while(true)
         {
            if(_loc7_)
