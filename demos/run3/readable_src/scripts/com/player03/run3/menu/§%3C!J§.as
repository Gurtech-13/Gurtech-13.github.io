package com.player03.run3.menu
{
   ...
   public class §<!J§ extends §'!O§
   {
      ...
      public var characters:Vector.<CharacterDef>;
      
      public var §8§:BitmapData;
      
      public function §<!J§(param1:int, param2:Vector.<CharacterDef>, param3:String = undefined, param4:Object = undefined)
      {
         §§push(false);
      ...
      public static function fromString(param1:String) : §<!J§
      {
         ...
         var _loc4_:* = §§pop();
         var _loc2_:* = null as Vector.<CharacterDef>;
         if(!_loc4_)
         {
      ...
      public static function §3g§(param1:String) : Vector.<CharacterDef>
      {
         §§push(false);
         var _loc8_:Boolean = true;
         var _loc9_:* = §§pop();
         var _loc7_:* = null as String;
         var _loc2_:Vector.<CharacterDef> = new Vector.<CharacterDef>(0,false);
         var _loc3_:Vector.<CharacterDef> = _loc2_;
         §§push(",");
         if(_loc8_)
         {
            §§push(§§pop());
         ...
         if(!_loc9_)
         {
            while(_loc5_ < int(_loc6_.length))
            {
               ...
               _loc3_.push(CharacterRegistry.§&!#§[int(Std.parseInt(_loc7_))]);
            }
         }
         return _loc3_;
      }
      ...
      public static function §2A§() : Vector.<BitmapData>
      {
         ...
         var _loc2_:* = 0;
         var _loc3_:* = null as Vector.<CharacterDef>;
