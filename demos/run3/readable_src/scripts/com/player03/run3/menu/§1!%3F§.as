   ...
   public class §1!?§ extends §[k§ implements §3!!§, §@[§
   {
      ...
      override public function §^g§() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  while(true)
                  {
                     if(!_loc15_)
                     {
                        §;!X§(500,"editor","Unlock the level editor.",Game.§-%§,null,"menu/EditIcon.png");
                        §#h§(CharacterRegistry.skater,"Unlock the Skater. (You also unlock him after Level 10.)");
                        §#h§(CharacterRegistry.lizard,"Unlock the Lizard. (Also available by beating Level 40.)");
                        §#h§(CharacterRegistry.child,"Unlock the Child. (Or you can beat the Low-Power Tunnel.)");
                        §#h§(CharacterRegistry.student,"Unlock the Student to pull off literal gravity-defying stunts.");
                        §#h§(CharacterRegistry.§#!P§,"Unlock the Angel, and get a burst of speed whenever you need it.");
                        if(!_loc16_)
                        {
                           break;
                        }
                        §#h§(CharacterRegistry.duplicator,"Unlock the Duplicator and his cloning/teleportation technology.");
                        if(_loc15_)
                        {
                           break loop14;
                        }
                        §#h§(CharacterRegistry.pastafarian,"Unlock the Pastafarian, and run on the void of space. Don\'t look down!");
                        if(!_loc15_)
                        {
                           §#h§(CharacterRegistry.§7W§,"Unlock the Bunny, the most hyperactive creature in the Solar System. (Alternatively, earn 8 achievements.)");
                           §#h§(CharacterRegistry.gentleman,"Unlock the Gentleman, an oddball who sewed a large electromagnet into his hat to attract power cells.");
                        }
                        ...
                        §2"§(CharacterRegistry.§4s§,"winter costumes","Unlock the winter costumes. (You can also unlock them by beating the Winter Games.)");
                        if(_loc15_)
                        {
                           break loop13;
                        }
                     }
                     §2"§(CharacterRegistry.§]![§,"halloween costumes","Unlock the Halloween costumes. (You can also unlock them by beating the Low-Power Tunnel.)");
                     break loop13;
                  }
                  §§goto(addr0721);
               }
            ...
            §2"§(CharacterRegistry.§=!O§,"pirate costume","Ahoy, mateys! Talk Like a Pirate Day has passed, but you can still get the pirate costume.");
            addr0721:
      ...
      public function §2"§(param1:CharacterDef, param2:String, param3:String) : §[!a§
      {
         §§push(false);
      ...
      public function §#h§(param1:CharacterDef, param2:String) : §[!a§
      {
         §§push(false);
