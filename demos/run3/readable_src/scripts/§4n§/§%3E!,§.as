package §4n§
{
   ...
   public class §>!,§
   {
               ...
               if(_loc8_)
               {
                  switch(_loc5_)
                  {
                     ...
                     case 10:
                        ...
                        if(_loc8_)
                        {
                           _loc4_ = new §#!G§(function(param1:Level):Number
                           {
                              var _temp_1:* = true;
                  ...
                  _loc6_ = new §#!G§(function(param1:Level):Number
                  {
                     var _temp_1:* = false;
      ...
      public function §-@§(param1:Achievement, param2:Object = undefined, param3:CharacterDef = undefined) : void
      {
      }
      
      public function §@B§(param1:Level, param2:§,!A§, param3:Object = undefined) : void
      {
         §§push(false);
      ...
      public function §]!M§(param1:Level) : void
      {
         var _temp_1:* = true;
         var _loc5_:Boolean = false;
      ...
      public function §%X§(param1:Level, param2:int) : void
      {
         §§push(false);
      ...
      public function §!c§(param1:Object, param2:Array, param3:§<!§, param4:Array = undefined, param5:Object = undefined, param6:String = undefined) : void
      {
         ...
         while(true)
         {
            ...
            {
               addr00ec:
               §=! §(param1,function(param1:§<!§, param2:Level, param3:Object):ConditionChain
               {
