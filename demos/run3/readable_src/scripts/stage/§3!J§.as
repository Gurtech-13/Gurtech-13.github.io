package stage
{
   ...
   public class §3!J§ implements §,D§
   {
      ...
      public function §3!J§(param1:StageActor, param2:int, param3:Number, param4:Object = undefined)
      {
         var _temp_1:* = true;
         ...
         var _loc6_:Point3D = param1.transform.getPosition();
         while(true)
         {
            if(!_loc7_)
            {
               ...
               QuaternionUtils.rotateVector(param1.transform.getRotation(),§6W§,§6W§);
               if(!_loc8_)
               {
                  break;
               }
      ...
      public function update(param1:Number) : void
      {
         ...
         while(true)
         {
            ...
            var _loc4_:Point3D = sprite.transform.getPosition();
