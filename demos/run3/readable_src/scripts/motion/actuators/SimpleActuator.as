package motion.actuators
{
   ...
   public class SimpleActuator extends GenericActuator
   {
      ...
      public var toggleVisible:Boolean = false;
      
      public var timeOffset:Number;
      
      public var startTime:Number = getTimer() / 1000;
      
      public var setVisible:Boolean = false;
      
      public var sendChange:Boolean = false;
      ...
      public var cacheVisible:Boolean = false;
      
      public var active:Boolean = true;
      
      public function SimpleActuator(param1:Object, param2:Number, param3:*)
      {
         ...
         if(!paused)
         {
            ...
            if(_loc5_ == 1)
            {
               if(_repeat == 0)
               {
                  ...
                  {
                     _loc13_ = target;
                     if(Reflect.hasField(_loc13_,"visible"))
                     {
                        _loc13_["visible"] = false;
                     }
                     else
                     {
                        Reflect.setProperty(_loc13_,"visible",false);
                     }
                  }
                  complete(true);
                  return;
      ...
      public function §[j§(param1:Object, param2:String, param3:*) : void
      {
      ...
      public function §7!L§(param1:Object, param2:String, param3:*) : void
      {
         if(Reflect.hasField(param1,param2))
         {
            param1[param2] = param3;
      ...
      public function §]C§(param1:Object, param2:String, param3:*) : void
      {
         if(Reflect.hasField(param1,param2))
         {
            param1[param2] = param3;
      ...
      public function §=q§(param1:Transform, param2:String, param3:*) : void
      {
         if(Reflect.hasField(param1,param2))
         {
            param1[param2] = param3;
      ...
      public function §,!E§(param1:DisplayObject, param2:String, param3:*) : void
      {
         if(Reflect.hasField(param1,param2))
         {
            param1[param2] = param3;
      ...
      override public function onUpdate(param1:*, param2:Array = undefined) : GenericActuator
      {
         _onUpdate = param1;
         if(param2 == null)
         {
      ...
      override public function move() : void
      {
         ...
         if(_loc1_)
         {
            ...
            cacheVisible = _loc3_;
            _loc4_ = target;
            if(Reflect.hasField(_loc4_,"visible"))
            {
               _loc4_["visible"] = true;
            }
            else
            {
               Reflect.setProperty(_loc4_,"visible",true);
            }
         }
      ...
      override public function delay(param1:Number) : GenericActuator
      {
         _delay = param1;
      ...
      override public function autoVisible(param1:Object = undefined) : GenericActuator
      {
         var _loc2_:* = null as Object;
         var _loc3_:* = null;
         if(param1 == null)
