package motion.actuators
{
   ...
   public class FilterActuator extends SimpleActuator
   {
      ...
      public function FilterActuator(param1:DisplayObject, param2:Number, param3:*)
      {
         var _loc4_:int = 0;
      ...
      override public function update(param1:Number) : void
      {
         ...
         if(filterIndex > -1)
         {
            _loc2_[properties.filter] = filter;
         }
         else
         {
            _loc3_ = 0;
            ...
            {
               _loc5_ = _loc3_++;
               if(Std.§is§(_loc2_[_loc5_],filterClass))
               {
                  _loc2_[_loc5_] = filter;
               }
            }
         }
         var _loc6_:DisplayObject = target;
         if(Reflect.hasField(_loc6_,"filters"))
         {
            _loc6_["filters"] = _loc2_;
         }
         else
         {
            Reflect.setProperty(_loc6_,"filters",_loc2_);
         }
      }
      ...
      override public function apply() : void
      {
         ...
         while(_loc1_ < int(_loc2_.length))
         {
            ...
            if(_loc3_ != "filter")
            {
               filter[_loc3_] = Reflect.field(properties,_loc3_);
            }
         }
         var _loc4_:DisplayObject = target;
         var _loc5_:* = null;
