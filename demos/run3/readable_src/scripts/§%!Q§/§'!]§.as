package §%!Q§
{
   ...
   public class §'!]§
   {
      ...
      public function §'!]§(param1:CharacterDef, param2:§ !>§, param3:int, param4:Object = undefined, param5:Object = undefined, param6:String = undefined, param7:Object = undefined, param8:Object = undefined, param9:§+Z§ = undefined)
      {
         var _temp_1:* = true;
      ...
      public function §!;§(param1:CharacterBase) : Boolean
      {
         §§push(false);
      ...
      public function § !7§(param1:Object = undefined) : void
      {
         ...
         while(true)
         {
            ...
            §§pop().§,Z§(new §§pop().Level(§§pop(),§&!-§,§,a§.CHALLENGE,§3[§));
            break;
         }
      }
   }
