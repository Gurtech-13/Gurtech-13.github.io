package §%!Q§
{
   ...
   public class §+#§
   {
      ...
      public static function §<!L§() : §+#§
      {
         ...
         _loc9_ = new §<!+§(§>K§.§>-§,5,4,true,new Point3D(0,85,4600),QuaternionUtils.setFromEuler(0,1.5707963267948966,0),null,null,null,3000,null,{"beginMessage":"It moves!\nI have no idea how I missed this the first time, but who cares?!\nThis box moves!"});
      ...
      public static function §"U§() : §+#§
      {
         ...
         _loc2_ = §§pop();
         addr00a5:
         _loc3_ = new §'!]§(CharacterRegistry.student,§>K§.§0x§,38,2,null,null,{
            "backwards":true,
            "noCrumblingTiles":true,
         ...
         if(_loc11_)
         {
            ...
            },_loc6_),new §'!]§(CharacterRegistry.student,§>K§.§>-§,5,2,null,null,{"beginMessage":"She\'s right. Two isn\'t enough either.\n" + "If they\'re different, then we wouldn\'t know which was the \"normal\" one!"})]);
            if(!_loc10_)
            {
               §§push(§§pop());
            }
      ...
      public static function §9!!§() : §+#§
      {
         ...
         while(true)
         {
            if(_loc5_)
            {
               §§push([new §<!+§(§>K§.§>-§,0,0,true,null,null,null,null,null,null,CharacterRegistry.§-P§,{
               ...
               }),new §<!+§(§>K§.§>=§,1,2,null,null,null,null,null,null,null,CharacterRegistry.§-P§,{
               ...
               }),new §<!+§(§>K§.§>=§,6,7,null,null,null,1612,null,null,null,CharacterRegistry.§-P§,{
      ...
      public static function §4!J§() : §+#§
      {
         ...
         _loc3_ = Vector.<§'!]§>([]);
         _loc4_ = new §<!+§(§>K§.§7&§,4,4,true,null,null,null,null,null,null,CharacterRegistry.skater,{
            "beginMessage":"Ok, I found one. Now what?",
            "startTilesLength":-1
         });
         _loc5_ = §>K§.§7&§;
         _loc6_ = CharacterRegistry.skater;
         _loc7_ = Cutscenes.§&w§();
         loop2:
         while(true)
         {
                  ...
                  if(!_loc6_)
                  {
                     ...
                     if(_loc5_)
                     {
                        ...
                        if(_loc5_)
                        {
                           ...
                           _loc3_ = Vector.<§'!]§>([]);
                           addr008c:
                           §§push([new §<!+§(§>K§.§7&§,1,0,true,null,null,null,null,null,null,CharacterRegistry.student,{
      ...
      public static function §!!`§() : §+#§
      {
         ...
         _loc5_ = §>K§.§`S§;
         _loc6_ = QuaternionUtils.setFromEuler(0,1.5707963267948966,0);
         _loc7_ = new Point(50,0);
         _loc8_ = CharacterRegistry.§-P§;
         _loc9_ = Cutscenes.§4,§();
         if(_loc12_)
         {
      ...
      public static function §<!4§() : §+#§
      {
         ...
         _loc3_ = new §'!]§(CharacterRegistry.student,§>K§.§>=§,6,2,null,null,{
            "backwards":true,
            "noCrumblingTiles":true,
         ...
         if(_loc15_)
         {
            ...
            },_loc6_),new §'!]§(CharacterRegistry.student,§>K§.§>y§,6,2,null,null,{"beginMessage":"He wants my help, but he doesn\'t want to test anything?\n" + "I guess he doesn\'t want my help."},function(param1:§'!]§):void
            {
               var _temp_1:* = false;
         ...
         _loc9_ = new §<!+§(§>K§.§>y§,7,6,true,null,null,1500,null,null,null,null,null,function():Object
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  if(_loc2_)
                  {
                     if(!CharacterRegistry.student.§3>§)
                     {
                        §§push("quitCallback");
                        break;
                     }
         ...
         _loc11_ = new §<!+§(§>K§.§>=§,0,1,null,null,null,null,null,null,null,null,{
            ...
            "onlyResetCharacter":function(param1:Level):Boolean
            {
               return false;
            }
         });
      ...
      public function §]!%§(param1:Level, param2:TunnelSection, param3:TunnelSection, param4:Number, param5:Number, param6:Number) : void
      {
         §§push(false);
      ...
      public function §#e§(param1:§<!+§, param2:TunnelSection) : Boolean
      {
         ...
         var _loc3_:§<!+§ = param1;
         var _loc4_:CharacterBase = param2.tunnel.characters[0];
         loop0:
         while(true)
         {
            loop1:
