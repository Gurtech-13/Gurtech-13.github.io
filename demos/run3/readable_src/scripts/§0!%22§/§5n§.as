package §0!"§
{
   ...
   public class §5n§ extends §,!Z§
   {
      ...
      public function §5n§(param1:Entity3D, param2:Point3D, param3:Number)
      {
         var _temp_1:* = true;
      ...
      final public function §9j§(param1:Point3D, param2:Point3D, param3:Object = undefined, param4:Object = undefined, param5:Point3D = undefined, param6:Quaternion = undefined) : Point3D
      {
         var _temp_1:* = true;
         ...
         var _loc7_:Quaternion = §!K§.transform.§>;§();
         while(true)
         {
            if(_loc12_)
            {
               if(_loc7_.w == 1)
               {
                  if(_loc12_)
                  {
                     ...
                     if(param6 != null)
                     {
                        if(_loc12_)
                        {
                           QuaternionUtils.§?!A§(§,!Z§.§>!1§,§5n§.§3C§,param6);
                        }
                     }
                     break;
                  }
               ...
               {
                  QuaternionUtils.rotateVector(_loc7_,normal,§5n§.§3C§);
                  if(_loc11_)
                  {
                     break;
                  }
            ...
            if(param1 is §[T§)
            {
               ...
               while(true)
               {
                  if(!_loc5_)
                  {
                     ...
                     {
                        QuaternionUtils.rotateVector(§!K§.transform.§>;§(),normal,§5n§.§1]§);
                        if(_loc5_)
                        {
                           break;
                        }
