package layout3d
{
   ...
   public class TunnelLayout3D extends Layout3D
   {
      ...
      public function TunnelLayout3D(param1:int, param2:int)
      {
         §§push(false);
         var _loc12_:Boolean = true;
         var _loc13_:* = §§pop();
         var _loc5_:* = NaN;
         var _loc6_:* = null as Vector.<Quaternion>;
      ...
      public function rotate(param1:Number) : void
      {
         ...
         var _loc16_:* = null as Quaternion;
         var _loc17_:* = NaN;
         §§push(0);
         if(!_loc19_)
         {
               ...
               while(_loc2_ < int(_loc13_.length))
               {
                  ...
                  while(true)
                  {
                     if(_loc20_)
                     {
                        ...
                        QuaternionUtils.rotateVector(_loc11_,_loc12_,_loc12_);
                        if(_loc19_)
                        {
                           break;
                        }
      ...
      override public function getPosition(param1:int, param2:PositionData3D = undefined) : PositionData3D
      {
         ...
         while(true)
         {
            ...
            param2.rotation = new Quaternion();
            break;
         }
         var _loc4_:Quaternion = param2.rotation;
         var _loc5_:Quaternion = §;;§[_loc3_];
         while(true)
         {
            if(_loc9_)
            {
      ...
      override public function getIndexNearest(param1:Point3D) : int
      {
         ...
         var _loc10_:* = NaN;
         var _loc12_:* = NaN;
         var _loc2_:Point3D = TunnelLayout3D.§1]§;
         loop2:
         while(true)
         {
            if(!_loc15_)
            ...
            while(true)
            {
               ...
               addr0067:
               QuaternionUtils.rotateVector(§-!Z§,TunnelLayout3D.§1]§,TunnelLayout3D.§1]§);
               break;
            }
            addr007e:
            §§push(Number(Math.atan2(TunnelLayout3D.§1]§.y,flipped ? -TunnelLayout3D.§1]§.x : TunnelLayout3D.§1]§.x)));
            if(!_loc15_)
            {
               §§push(Number(§§pop()));
            }
            ...
            while(true)
            {
               ...
               var _loc8_:Point = TunnelLayout3D.§1]§;
      ...
      override public function getAreaBounds() : §,!Z§
      {
         ...
         var _loc15_:* = null as Quaternion;
         var _loc16_:* = null as Quaternion;
         loop10:
         while(true)
         {
