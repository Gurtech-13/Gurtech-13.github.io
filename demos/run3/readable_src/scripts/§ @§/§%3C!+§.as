package § @§
{
   ...
   public class §<!+§ extends §'!]§
   {
      ...
      public function §<!+§(param1:§ !>§, param2:int, param3:int, param4:Object = undefined, param5:Point3D = undefined, param6:Quaternion = undefined, param7:Object = undefined, param8:Point = undefined, param9:Object = undefined, param10:Object = undefined, param11:CharacterDef = undefined, param12:Object = undefined, param13:Object = undefined, param14:Object = undefined, param15:Object = undefined, param16:§+Z§ = undefined)
      {
         §§push(false);
         ...
         param11 = CharacterRegistry.student;
         addr00b6:
         §7u§ = param13;
         §+!H§ = param5;
         break loop1;
         ...
         while(true)
         {
            if(!_loc3_)
            {
               ...
               while(true)
               {
                  ...
                  {
                     param1.victoryCondition = function(param1:CharacterBase):Boolean
                     {
                        return false;
                     };
                     addr00d5:
      ...
      override public function § !7§(param1:Object = undefined) : void
      {
         ...
         var _loc3_:CharacterBase = _loc2_.characters[0];
         ...
         var _loc6_:Quaternion = §^1§.transform.§,t§;
         var _loc7_:Quaternion = §!l§;
         _loc6_.x = _loc7_.x;
         _loc6_.y = _loc7_.y;
         _loc6_.z = _loc7_.z;
         _loc6_.w = _loc7_.w;
      ...
      public function §?#§(param1:Level) : Boolean
      {
         var _temp_1:* = true;
