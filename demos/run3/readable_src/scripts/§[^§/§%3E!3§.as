package §[^§
{
   ...
   public class §>!3§ extends §+F§
   {
      ...
      public function §>!3§()
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  while(true)
                  {
                     ...
                     if(_loc4_)
                     {
                        ...
                        if(§§pop())
                        {
                           ...
                           _loc1_.setReserved("boat",function(param1:Level, param2:§=!U§):Model
                           {
                        ...
                        {
                           _loc1_.h["boat"] = function(param1:Level, param2:§=!U§):Model
                           {
                              return §>!3§.§,9§(false,false,false,param1,param2);
                           };
                           if(_loc3_)
                  ...
                  if(§§pop())
                  {
                     _loc1_.setReserved("boatBottom",function(param1:Level, param2:§=!U§):Model
                     {
                        return §>!3§.§,9§(false,true,false,param1,param2);
                     });
                     break;
                  }
                  _loc1_.h["boatBottom"] = function(param1:Level, param2:§=!U§):Model
                  {
                     return §>!3§.§,9§(false,true,false,param1,param2);
                  };
                  break;
         ...
         if(§§pop() in StringMap.§+!#§)
         {
            _loc1_.setReserved("boatInside",function(param1:Level, param2:§=!U§):Model
            {
               return §>!3§.§,9§(true,false,false,param1,param2);
            });
            break loop1;
         }
         _loc1_.h["boatInside"] = function(param1:Level, param2:§=!U§):Model
         {
            return §>!3§.§,9§(true,false,false,param1,param2);
         };
         break loop1;
      ...
      public static function §=!2§(param1:Level, param2:§=!U§) : Model
      {
         var _temp_1:* = true;
      ...
      public static function §5!6§(param1:Level, param2:§=!U§) : Model
      {
         §§push(false);
      ...
      public static function §,9§(param1:Boolean, param2:Boolean, param3:Boolean, param4:Level, param5:§=!U§) : Model
      {
         var _temp_1:* = true;
