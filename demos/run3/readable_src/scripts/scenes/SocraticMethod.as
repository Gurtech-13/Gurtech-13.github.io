            ...
            while(true)
            {
               if(!_loc10_)
               {
                  ...
                  if(!_loc10_)
                  {
                     ...
                     QuaternionUtils.multiply(_loc1_.transform.§,t§,QuaternionUtils.setFromEuler(-1.5707963267948966,0,0),_loc1_.transform.§,t§);
                  }
