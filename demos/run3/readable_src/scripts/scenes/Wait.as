   ...
   public class Wait extends §+Z§
   {
      ...
      override public function §1!F§() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               CharacterRegistry.§#!P§.§>t§.§?F§(§>K§.§"!R§.pathName);
               if(_loc1_)
               {
                  break;
               }
            }
            CharacterRegistry.§#!P§.§ j§.§?F§(0);
            if(!_loc1_)
            {
               break;
            }
      ...
      public function frame3() : void
      {
         ...
         var _loc4_:* = §§pop();
         duplicator.placeAt(7.1,-1.3,true,-4);
      ...
      public function frame2() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               duplicator.placeAt(7,-1.4,true,-2);
               duplicator.spritesheet.§,=§(46);
               duplicator.spritesheet.§@S§(true);
               child.placeAt(6.5,-3.1,true,15);
      ...
      public function frame1() : void
      {
         ...
         var _loc1_:Boolean = true;
         var _loc2_:* = §§pop();
         duplicator.placeAt(6.4,-3,true,23);
         while(true)
         {
            if(!_loc2_)
            {
            ...
            child.spritesheet.§@S§(true);
            duplicator.transform.setRotation(child.transform.getRotation());
            break;
         }
      }
         ...
         while(true)
         {
            ...
            while(true)
            {
               while(true)
               {
                  ...
                  if(_loc8_)
                  {
                     duplicator.placeAt(5.4,-4,true,25);
                     if(!_loc7_)
                     {
                        break loop10;
                     }
