   ...
   public class MorningHypothesis extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         if(!_loc3_)
         {
            tunnel.camera.reset();
            tunnel.display(0);
            student.placeAt(1.1,84.3,null,9);
            if(_loc4_)
            {
      ...
      public function frame3() : void
      {
         ...
         while(true)
         {
            ...
            if(_loc1_)
            {
               student.placeAt(1.1,83.9,null,8);
               if(_loc2_)
               {
                  break;
               }
      ...
      public function frame11() : void
      {
         ...
         if(!_loc4_)
         {
            ...
            tunnel.camera.reset();
            tunnel.display(0);
            student.placeAt(1.1,85.9,null,14);
      ...
      public function frame10() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               ...
               tunnel.camera.reset();
               tunnel.display(0);
               student.placeAt(1.1,84.9,null,11);
               if(!_loc3_)
               {
                  break;
               }
