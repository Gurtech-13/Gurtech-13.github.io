   ...
   public class StandardsToUphold extends §+Z§
   {
      ...
      public function frame5() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               tunnel.camera.translate(0,0,60);
               if(_loc1_)
               {
                  break;
               }
      ...
      public function frame0() : void
      {
         ...
         if(_loc8_)
         {
            ...
            if(!_loc7_)
            {
               tunnel.camera.rotate(QuaternionUtils.setFromEuler(0,-0.5235987755982988,0));
            }
            tunnel.display(0);
            §#!P§.placeAt(3,-2.2,true,10);
            if(!_loc7_)
            {
               §#!P§.spritesheet.§,=§(0);
               gentleman.placeAt(2,1,true);
               if(_loc8_)
               {
