package scenes
{
   ...
   public class TheNextBigThing extends §+Z§
   {
      ...
      public function frame4() : void
      {
         ...
         tunnel.display(0);
         §#!P§.placeAt(13,25.8,null,20);
         while(true)
         {
            if(!_loc3_)
            {
               §#!P§.spritesheet.§,=§(8);
               skater.placeAt(14,27.5);
               if(_loc3_)
               {
                  break;
               }
      ...
      public function frame3() : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_)
            {
               §#!P§.placeAt(13,22.5,null,65);
               if(_loc2_)
               {
                  skater.placeAt(14,23.5,null,50);
                  if(!_loc3_)
                  {
                     break;
                  }
      ...
      public function frame2() : void
      {
         ...
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
         tunnel.camera.translate(0,0,120);
         tunnel.display(0);
         §#!P§.placeAt(13,19,null,2);
         §#!P§.spritesheet.§,=§(0);
         skater.placeAt(14,20.5,null,2);
         if(_loc2_)
         {
      ...
      public function frame0() : void
      {
         ...
         if(!_loc3_)
         {
            QuaternionUtils.setFromEuler(0,2.199114857512855,0,tunnel.camera.§,t§);
         }
         tunnel.camera.reset();
         if(_loc2_)
         {
            tunnel.camera.§6!&§(-100,-40,900);
            while(true)
            {
               while(true)
               {
