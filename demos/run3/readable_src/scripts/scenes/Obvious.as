   ...
   public class Obvious extends §+Z§
   {
      ...
      public function frame7() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               addr0219:
               pastafarian.placeAt(7.9,-17.8,true,-2);
               if(_loc8_)
               {
                  break loop5;
               }
      ...
      public function frame3() : void
      {
         ...
         while(true)
         {
            ...
            addr022c:
            tunnel.display(0);
            pastafarian.placeAt(7.8,-18.2,true,-4);
            if(_loc9_)
            {
               pastafarian.spritesheet.§,=§(107);
            }
      ...
      public function frame1() : void
      {
         ...
         var _loc3_:Boolean = true;
         var _loc4_:* = §§pop();
         pastafarian.placeAt(7.8,-19,true);
         pastafarian.spritesheet.§,=§(103);
         if(_loc3_)
         {
            pastafarian.spritesheet.§@S§(true);
         }
         §#!P§.placeAt(8.3,-19.6,true,1);
         §#!P§.spritesheet.§,=§(71);
         if(!_loc4_)
         {
            §#!P§.spritesheet.§@S§(false);
               ...
               while(true)
               {
                  ...
                  while(true)
                  {
                     if(_loc8_)
                     {
                        ...
                        tunnel.camera.reset();
                        tunnel.display(0);
                        pastafarian.placeAt(7.7,-19.9,true,-6);
                        pastafarian.spritesheet.§,=§(107);
                        pastafarian.spritesheet.§@S§(true);
                     }
                     §#!P§.placeAt(8.3,-20.3,true);
                     break loop5;
                  }
                  §§goto(addr0271);
               }
