   ...
   public class StopSolvingProblems extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         while(true)
         {
            if(_loc4_)
            {
               §7!!§.§7#§(0.8,§7!!§.position.x,§7!!§.position.y,section.endZ + 600).ease(§>!9§.get_easeOut());
               if(!_loc4_)
               {
                  break;
               }
               duplicator.placeAt(10,-4.1,true);
               if(_loc5_)
               {
                  break;
               }
      ...
      public function frame8() : void
      {
         ...
         while(true)
         {
            if(!_loc5_)
            {
               duplicator.placeAt(10,-4.5,true);
               if(_loc5_)
               {
                  break;
               }
      ...
      public function frame7() : void
      {
         ...
         duplicator.placeAt(10,-4.7,true);
      ...
      public function frame5() : void
      {
         ...
         var _loc5_:* = §§pop();
         §7!!§.translate(0,-10,-5);
         duplicator.placeAt(10,-5.5,true);
      ...
      public function frame4() : void
      {
         ...
         while(true)
         {
            if(!_loc3_)
            {
               duplicator.placeAt(10,-6.4,true);
               if(!_loc3_)
               {
                  duplicator.spritesheet.§,=§(86);
                  if(!_loc3_)
      ...
      public function frame2() : void
      {
         ...
         if(_loc5_)
         {
            duplicator.placeAt(10,-6.6,true);
      ...
      public function frame13() : void
      {
         ...
         while(true)
         {
            if(!_loc4_)
            {
               duplicator.placeAt(10,-3.1,true);
               if(_loc4_)
               {
                  break;
               }
      ...
      public function frame11() : void
      {
         ...
         while(true)
         {
            ...
            {
               §7!!§.translate(0,0,-30);
               duplicator.placeAt(10,-3.4,true);
               if(!_loc5_)
               {
                  break;
               }
      ...
      public function frame10() : void
      {
         ...
         while(true)
         {
            if(!_loc5_)
            {
               ...
               if(_loc4_)
               {
                  duplicator.placeAt(10,-3.7,true);
                  if(_loc5_)
                  {
                     break;
                  }
      ...
      public function frame1() : void
      {
         ...
         if(!_loc2_)
         {
            duplicator.placeAt(10,-7.3,true);
            duplicator.spritesheet.§,=§(34);
         }
         duplicator.spritesheet.§@S§(true);
         if(!_loc2_)
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               {
                  tunnel.display(0);
                  duplicator.placeAt(10,-8,true);
                  addr023b:
                  duplicator.spritesheet.§,=§(30);
                  duplicator.spritesheet.§@S§(true);
                  if(_loc10_)
                  {
                     §#!P§.placeAt(0.6,2.78e-17,null,54);
                  }
               }
               §#!P§.spritesheet.§,=§(73);
               if(_loc10_)
      ...
      public function §4!@§() : void
      {
         ...
         while(true)
         {
            ...
            addr0283:
            var _loc7_:Quaternion = _loc6_.transform.§,t§;
            while(true)
            {
               if(!_loc10_)
               {
