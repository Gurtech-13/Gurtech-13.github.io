   ...
   public class MorningHypothesis2 extends §+Z§
   {
      ...
      public function frame8() : void
      {
         ...
         while(true)
         {
            if(!_loc3_)
            {
               student.placeAt(17.8,-1.2,null,-4);
               if(!_loc2_)
               {
                  break;
               }
      ...
      public function frame4() : void
      {
         ...
         if(!_loc8_)
         {
            student.section = tunnel.§]!#§(7000,true);
         }
      ...
      public function frame3() : void
      {
         ...
         {
            addr020f:
            student.placeAt(1.2,90.5,null,31);
            if(!_loc8_)
            {
      ...
      public function frame2() : void
      {
         ...
         while(true)
         {
            if(!_loc5_)
            {
               student.placeAt(1.3,89.2,null,26);
               if(_loc5_)
               {
                  break;
               }
      ...
      public function frame1() : void
      {
         ...
         if(_loc4_)
         {
            student.placeAt(1.1,88,null,21);
      ...
      public function frame0() : void
      {
         ...
         addr0212:
         tunnel.display(0);
         student.placeAt(1.1,86.9,null,18);
         if(_loc8_)
         {
