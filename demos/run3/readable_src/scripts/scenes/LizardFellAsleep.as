         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(!_loc18_)
               {
                  ...
                  var _loc12_:Point3D = tunnel.camera.§%!7§;
                  while(true)
                  {
                     if(_loc19_)
                     {
                  ...
                  var _loc13_:Point3D = lizard.transform.getPosition();
                  var _loc14_:Point3D = tunnel.camera.§%!7§;
                  ...
                  QuaternionUtils.rotateVector(lizard.transform.getRotation(),_loc12_,_loc12_);
                  QuaternionUtils.fromAxes(_loc16_,_loc12_,tunnel.camera.§,t§);
                  while(true)
                  {
                     if(!_loc18_)
                     {
