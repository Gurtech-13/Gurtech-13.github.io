   ...
   public class Discoveries extends §+Z§
   {
      ...
      override public function §1!F§() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               CharacterRegistry.§7W§.§>t§.§?F§("winter");
               if(!_loc2_)
               {
                  CharacterRegistry.§7W§.§ j§.§?F§(9);
                  CharacterRegistry.child.§>t§.§?F§("winter");
                  if(!_loc2_)
                  {
                     CharacterRegistry.child.§ j§.§?F§(6);
                     CharacterRegistry.duplicator.§>t§.§?F§("winter");
                     CharacterRegistry.duplicator.§ j§.§?F§(7);
                  }
                  CharacterRegistry.pastafarian.§>t§.§?F§("winter");
                  if(_loc2_)
                  {
                     break;
                  }
            ...
            CharacterRegistry.pastafarian.§ j§.§?F§(10);
            if(!_loc2_)
            {
               super.§1!F§();
            }
      ...
      public function frame5() : void
      {
         ...
         while(true)
         {
            ...
            student.placeAt(22.05,4,null,1);
            if(!_loc3_)
            {
            ...
            if(_loc4_)
            {
               ...
               while(true)
               {
                  if(_loc4_)
                  {
                     ...
                     student.placeAt(21.95,3.95,null,3);
                  }
      ...
      public function frame1() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               ...
               student.transform.setRotation(§#!P§.transform.getRotation());
               if(!_loc3_)
               {
                  break loop0;
               }
