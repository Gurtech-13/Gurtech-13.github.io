   ...
   public class DontQuestionIt extends §+Z§
   {
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            ...
            {
               box.reset();
               box.transform.setRotation(QuaternionUtils.setFromEuler(0,-1.2566370614359172,0));
               if(_loc4_)
               {
                  box.transform.§6!&§(80,90,1800);
                  tunnel.§`=§(box);
               }
               QuaternionUtils.setFromEuler(3.141592653589793,1.8849555921538759,0.031415926535897934,tunnel.camera.§,t§);
               if(!_loc4_)
               {
                  break;
               }
