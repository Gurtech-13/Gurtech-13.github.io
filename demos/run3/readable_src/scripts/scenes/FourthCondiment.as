package scenes
{
   ...
   public class FourthCondiment extends §+Z§
   {
      ...
      public function frame5() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               pastafarian.transform.setRotation(child.transform.getRotation());
               break;
            }
            return;
         }
         pastafarian.placeAt(2,8.7,true,3);
         addr0092:
      ...
      public function frame2() : void
      {
         ...
         var _loc3_:Boolean = true;
         var _loc4_:* = §§pop();
         duplicator.placeAt(3,1.3,true);
         if(_loc3_)
         {
            duplicator.spritesheet.§,=§(76);
            duplicator.spritesheet.§@S§(true);
            child.placeAt(3,6.9,true,1);
            if(_loc3_)
            {
      ...
      public function frame1() : void
      {
         ...
         duplicator.placeAt(3,-1,true,20);
         duplicator.spritesheet.§,=§(74);
         duplicator.spritesheet.§@S§(false);
         if(_loc6_)
         {
            child.placeAt(3,7,true);
         }
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            ...
            addr022d:
            duplicator.placeAt(3,-7,true,20);
            while(true)
            {
               if(!_loc10_)
               {
