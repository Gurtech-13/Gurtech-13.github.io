   ...
   public class Teapot extends §+Z§
   {
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            if(_loc5_)
            {
               QuaternionUtils.setFromEuler(1.5707963267948966,1.5707963267948966,0,_loc1_.transform.§,t§);
               _loc1_.transform.reset();
               tunnel.§`=§(_loc1_);
               QuaternionUtils.setFromEuler(0,-1.5707963267948966,-0.039269908169872414,tunnel.camera.§,t§);
               if(_loc5_)
               {
                  tunnel.camera.§%!7§.x = 180;
                  if(!_loc5_)
                  {
                     break;
                  }
                  tunnel.camera.§%!7§.y = 0;
                  tunnel.camera.§%!7§.z = -70;
                  tunnel.camera.reset();
               }
            }
            tunnel.display(0);
