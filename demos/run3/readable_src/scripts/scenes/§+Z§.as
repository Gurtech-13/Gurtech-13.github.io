package scenes
{
   ...
   public class §+Z§
   {
      ...
      public var sprites:Vector.<StageActor>;
      ...
      public function §1!F§() : void
      {
         ...
         var _loc1_:* = §§pop();
         var _loc2_:Vector.<StageActor> = sprites;
         if(_loc5_)
         {
            loop0:
      ...
      public function §+_§(param1:§ !>§, param2:int, param3:Object = undefined) : void
      {
         ...
         while(true)
         {
            ...
            tunnel = new Level(param2,param1,§,a§.CUTSCENE,param3);
            break;
         }
         tunnel.display(0);
         Main.instance.§,Z§(tunnel);
         section = tunnel.§]!#§(0,true);
         sprites.length = 0;
         init();
      }
      ...
      final public function display(param1:int) : void
      {
         ...
         var _loc7_:* = §§pop();
         var _loc3_:* = null as Vector.<StageActor>;
         ...
         try
         {
            if(sprites == null)
            {
               _loc3_ = new Vector.<StageActor>(0,false);
               if(_loc6_)
               {
                  sprites = _loc3_;
               }
      ...
      public function §3! §() : void
      {
         ...
         if(Main.instance.tunnel != null)
         {
            ...
            tunnel = new Level(§>+§,§!^§,§,a§.CUTSCENE,tunnelParams);
            addr005c:
            while(true)
            {
               if(_loc2_)
