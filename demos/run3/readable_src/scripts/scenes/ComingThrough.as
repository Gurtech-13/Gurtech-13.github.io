   ...
   public class ComingThrough extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         if(!_loc11_)
         {
            ...
            skater.placeAt(1.3,60,null,100);
            addr01fc:
         }
      ...
      public function frame8() : void
      {
         ...
         while(true)
         {
            ...
            skater.placeAt(15.6,60,null,37);
            break;
         }
         skater.spritesheet.§,=§(96);
         if(_loc2_)
      ...
      public function frame21() : void
      {
         ...
         var _loc3_:Boolean = false;
         var _loc4_:Boolean = _temp_1;
         tunnel.camera.translate(0,0,80);
         map.§#"§(false);
         if(!_loc3_)
         {
            §-P§.placeAt(11.8,60.3);
         ...
         §-P§.spritesheet.§,=§(28);
         §-P§.spritesheet.§@S§(true);
         skater.placeAt(12.1,61.4,null,27);
         if(!_loc3_)
         {
         ...
         if(§§pop() == §§pop())
         {
            ...
            while(true)
            {
               if(!_loc7_)
               {
                  ...
                  tunnel.camera.translate(0,-30,10);
                  if(_loc7_)
                  {
                     break;
                  }
      ...
      public function frame17() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               _loc1_.setRotation(_loc2_);
               tunnel.camera.translate(0,-70,20);
               §§goto(addr020a);
            }
            §-P§.spritesheet.§@S§(true);
            skater.placeAt(12.2,60.7,null,85);
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               if(!_loc7_)
               {
                  ...
                  _loc1_.setRotation(_loc2_);
                  addr021c:
                  tunnel.camera.translate(0,-50,20);
                  §-P§.placeAt(12,60.2,null,195);
                  §-P§.spritesheet.§,=§(7);
                  §-P§.spritesheet.§@S§(true);
                  if(_loc6_)
                  {
                     skater.placeAt(12.3,60.5,null,185);
                     if(_loc6_)
                     {
                        break loop10;
                     }
      ...
      public function frame15() : void
      {
         ...
         _loc1_.setRotation(_loc2_);
         addr01fd:
         tunnel.camera.translate(0,-30,20);
         if(!_loc11_)
         {
            break loop5;
         }
         addr024d:
         skater.placeAt(12.4,60.3,null,260);
         if(_loc10_)
         {
            addr0266:
         ...
         var _loc6_:Quaternion = §-P§.transform.getRotation();
         if(_loc6_ == null)
         {
         ...
         while(true)
         {
            ...
            var _loc8_:Quaternion = _loc6_;
            if(!_loc11_)
            {
               §-P§.transform.rotate(_loc8_);
            }
            var _loc9_:Quaternion = _loc8_;
            loop11:
            while(true)
            {
               if(_loc10_)
      ...
      public function frame14() : void
      {
         ...
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = _temp_1;
         tunnel.camera.translate(0,0,20);
         while(true)
         {
            if(_loc3_)
            {
               §-P§.placeAt(4,60,null,50);
               §-P§.spritesheet.§,=§(4);
               §-P§.spritesheet.§@S§(true);
               skater.placeAt(3.5,60.1,null,25);
               if(_loc2_)
               {
                  break;
               }
      ...
      public function frame13() : void
      {
         ...
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
         tunnel.camera.translate(0,0,10);
         §-P§.placeAt(4,59.9,null,25);
         if(_loc2_)
         {
            §-P§.spritesheet.§,=§(0);
            §-P§.spritesheet.§@S§(true);
            skater.placeAt(3.5,60);
            skater.spritesheet.§,=§(90);
            if(_loc2_)
            {
               skater.spritesheet.§@S§(true);
      ...
      public function frame1() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               addr03f6:
               map.transform.setRotation(§'^§);
               var _loc10_:Quaternion = §'^§;
               var _loc11_:Quaternion = §'^§;
               if(_loc12_)
               {
                  if(_loc11_ == null)
                  {
                     _loc11_ = new Quaternion();
                  }
                  §§push(_loc11_);
                  §§push(_loc10_.x);
                  if(_loc12_)
