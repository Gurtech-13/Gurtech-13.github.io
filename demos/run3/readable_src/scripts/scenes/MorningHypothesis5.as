package scenes
{
   ...
   public class MorningHypothesis5 extends §+Z§
   {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  student.placeAt(18.5,-0.9,null,-1);
                  addr022b:
         ...
         while(true)
         {
            ...
            if(!_loc6_)
            {
               ...
               while(true)
               {
                  ...
                  {
                     tunnel.display(0);
                     student.placeAt(16.69,98.1,null,-11);
                  }
                  §-P§.placeAt(16.8,105,null,-50);
                  if(!_loc6_)
                  {
      ...
      public function frame17() : void
      {
         ...
         student.placeAt(16.685,98.1,null,-2);
         while(true)
         {
            if(!_loc1_)
            {
      ...
      public function frame14() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               student.placeAt(16.7,98.2,null,-10);
               if(_loc7_)
               {
                  addr0256:
      ...
      public function frame13() : void
      {
         ...
         if(!_loc2_)
         {
            student.placeAt(16.7,98.1,null,-10);
            if(_loc3_)
            {
