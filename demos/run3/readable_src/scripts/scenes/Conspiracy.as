package scenes
{
   ...
   public class Conspiracy extends §+Z§
   {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              if(_loc11_)
                              {
                                 ...
                                 _loc3_ = §§pop();
                                 addr044c:
                                 QuaternionUtils.slerp(§&!b§,§"!'§,_loc3_,tunnel.camera.§,t§);
                                 ...
                                 if(!_loc10_)
                                 {
                                    ...
                                    while(true)
                                    {
                                       ...
                                       if(_loc11_)
                                       {
                                          QuaternionUtils.rotateVector(tunnel.camera.§,t§,§>0§,§>0§);
                                       }
                                       break;
                                    }
                                 }
                                 ...
                                 var _loc9_:Point3D = tunnel.camera.§%!7§;
                                 if(_loc9_ == null)
                                 {
      ...
      public function frame3() : void
      {
         ...
         duplicator.placeAt(4.8,30.7);
         duplicator.spritesheet.§,=§(77);
         duplicator.spritesheet.§@S§(true);
         if(!_loc3_)
         {
            child.placeAt(3,30.9);
            child.spritesheet.§,=§(102);
         }
         child.spritesheet.§@S§(true);
