package scenes
{
   ...
   public class PlanetStolen extends §+Z§
   {
      ...
      public function frame1() : void
      {
         ...
         if(_loc2_)
         {
            §-P§.placeAt(4,29.5,null,3);
            if(!_loc3_)
            {
               §-P§.spritesheet.§,=§(65);
               §-P§.spritesheet.§@S§(true);
               duplicator.placeAt(2.5,31.5);
               duplicator.spritesheet.§,=§(69);
               §-P§.transform.setRotation(duplicator.transform.getRotation());
               if(_loc2_)
               {
      ...
      public function frame0() : void
      {
         ...
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
         QuaternionUtils.setFromEuler(3.141592653589793,0.7853981633974483,0,tunnel.camera.§,t§);
         tunnel.camera.§%!7§.x = 60;
         tunnel.camera.§%!7§.y = 60;
         tunnel.camera.§%!7§.z = 2600;
         while(true)
         {
            while(true)
            {
               ...
               child.placeAt(1.3,12.5,null,-26);
