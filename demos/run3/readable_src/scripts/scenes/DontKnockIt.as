package scenes
{
   ...
   public class DontKnockIt extends §+Z§
   {
      ...
      public function frame8() : void
      {
         ...
         skater.placeAt(12.6,1.8,null,35);
      ...
      public function frame4() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               skater.placeAt(12.1,6.8,null,-45);
      ...
      public function frame3() : void
      {
         ...
         var _loc1_:Boolean = false;
         var _loc2_:Boolean = _temp_1;
         skater.placeAt(13.4,2.8,null,25);
         skater.spritesheet.§,=§(14);
         skater.spritesheet.§@S§(false);
         while(true)
         {
      ...
      public function frame1() : void
      {
         ...
         if(!_loc1_)
         {
            ...
            if(!_loc1_)
            {
               skater.placeAt(18.3,16,null,-26);
            }
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            if(!_loc7_)
            {
               §!!9§ = new §4S§(CharacterRegistry.skater,skater.spritesheet,tunnel.§"[§);
               if(!_loc6_)
               {
                  break;
               }
