package scenes
{
   ...
   public class SomethingWeird extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         if(!_loc2_)
         {
            student.placeAt(0.36,25.95,null,-45);
            if(!_loc2_)
            {
               student.spritesheet.§,=§(88);
               if(_loc1_)
               {
                  tunnel.camera.translate(20,0,-3);
               }
            }
         }
      }
      ...
      public function frame7() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               student.placeAt(0.36,26.1,null,-41);
               if(!_loc2_)
               {
      ...
      public function frame6() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               student.placeAt(0.34,26.1,null,-15);
               if(!_loc2_)
               {
                  ...
                  student.transform.rotate(QuaternionUtils.setFromEuler(0,3.7699111843077517,0));
                  if(_loc2_)
                  {
                     break;
                  }
      ...
      public function frame5() : void
      {
         ...
         while(true)
         {
            ...
            if(_loc3_)
            {
               student.placeAt(0.36,26.1,null,10);
      ...
      public function frame4() : void
      {
         ...
         while(true)
         {
            if(!_loc15_)
            {
               student.placeAt(0.7,26.1,null,42.5);
               if(!_loc14_)
               {
                  break;
               }
         ...
         if(_loc14_)
         {
            cameraPosition = tunnel.camera.§7#§(_loc6_,tunnel.camera.position.x,tunnel.camera.position.y,2275);
         }
         var _loc7_:Transform = tunnel.camera;
         var _loc8_:Point3D = new Point3D(-0.604,-0.547,-0.579);
         var _loc9_:Quaternion = null;
         while(true)
         {
            if(_loc14_)
            {
      ...
      public function frame3() : void
      {
         ...
         if(_loc2_)
         {
            student.placeAt(0.5,25.7,null,42.5);
            if(_loc2_)
            {
      ...
      public function frame2() : void
      {
         ...
         if(!_loc3_)
         {
            student.placeAt(0,25.2,null,43);
            while(true)
            {
               if(_loc2_)
               {
      ...
      public function frame14() : void
      {
         ...
         if(_loc2_)
         {
            student.placeAt(0.39,27,null,-80);
            while(true)
            {
               if(!_loc1_)
               {
                  ...
                  if(_loc2_)
                  {
                     student.transform.rotate(QuaternionUtils.setFromEuler(0,0.3141592653589793,0));
                     if(_loc1_)
                     {
                        break;
                     }
      ...
      public function frame13() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               student.placeAt(0.41,26.6,null,-60);
               if(_loc1_)
               {
                  break;
               }
            ...
            if(_loc2_)
            {
               student.transform.rotate(QuaternionUtils.setFromEuler(0,-0.6283185307179586,0));
               if(!_loc2_)
               {
                  break;
               }
      ...
      public function frame12() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               student.placeAt(0.43,25.9,null,-17);
               if(!_loc2_)
               {
               ...
               student.transform.rotate(QuaternionUtils.setFromEuler(0,-1.5707963267948966,0));
               if(!_loc1_)
               {
                  break;
               }
      ...
      public function frame11() : void
      {
         ...
         while(true)
         {
            ...
            student.placeAt(0.46,25.69,null,-17);
            if(_loc1_)
            {
               break;
            }
      ...
      public function frame10() : void
      {
         ...
         if(!_loc2_)
         {
            student.placeAt(0.36,25.73,null,-28);
            if(!_loc2_)
            {
      ...
      public function frame1() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               student.placeAt(11.6,28,null,95);
               if(_loc3_)
               {
                  break;
               }
            ...
            while(true)
            {
               ...
               else
               {
                  ...
                  while(true)
                  {
                     ...
                     student.placeAt(11.5,29,null,65);
                     break;
                  }
