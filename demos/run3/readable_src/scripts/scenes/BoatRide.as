package scenes
{
   ...
   public class BoatRide extends §+Z§
   {
      ...
      public static var §;D§:Quaternion;
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              if(_loc10_)
                              {
                                 while(true)
                                 {
                                    §§push(section.tunnelBounds.contains(§7W§.transform.getPosition()));
                                    if(_loc10_)
                                    {
                                       §§push(Boolean(§§pop()));
                                       if(_loc9_)
      ...
      public function §`k§() : void
      {
         ...
         if(!_loc5_)
         {
            if(§-$§ != null)
            {
               ...
               §-$§.y = _loc2_;
               §-$§.z = _loc3_;
               QuaternionUtils.rotateVector(BoatRide.§;D§,§-$§,§-$§);
               §§push(§#!P§.transform);
               §§push(0.2);
               §§push(§#!P§.§#!K§());
               if(_loc4_)
      ...
      public function §0!a§(param1:StageActor) : void
      {
         var _temp_1:* = true;
      ...
      public function §`!6§() : void
      {
         ...
         var _loc1_:PositionData3D = §§pop().getPosition(§§pop());
         var _loc2_:Quaternion = _loc1_.rotation;
         ...
         addr020b:
         QuaternionUtils.multiply(_loc2_,_loc3_,_loc1_.rotation);
         var _loc7_:Point3D = §9p§.transform.getPosition();
         if(!_loc11_)
         {
            _loc7_.x = -0.47;
            while(true)
            {
               ...
               QuaternionUtils.rotateVector(_loc1_.rotation,_loc7_,_loc7_);
               break;
            }
         }
         ...
         §9p§.transform.setRotation(_loc1_.rotation);
         §9p§.update(0);
         addr038a:
      }
      ...
      public function §"5§() : void
      {
         ...
         if(_loc1_)
         {
            ...
            while(true)
            {
               if(!_loc2_)
               {
                  tunnel.camera.translate(0,0,500);
                  if(!_loc1_)
                  {
                     break;
                  }
      ...
      override public function loadNext(param1:Boolean, param2:Boolean) : void
      {
         ...
         while(true)
         {
            ...
            if(!_loc3_)
            {
               §'[§.§7!@§(CharacterRegistry.duplicator,["Son, why didn\'t you come with me?","Wait, I know: you\'re gathering intelligence!","Good for you, son! I\'m glad you\'re learning to take initiative."]);
            }
            break;
         }
      }
      ...
      override public function init() : void
      {
         ...
         if(!_loc6_)
         {
            pastafarian = new StageActor(section,CharacterRegistry.pastafarian,false,null,false,"cutscene/TrainRide/Spritesheet.png");
            if(_loc7_)
            {
         ...
         while(true)
         {
            ...
            §#!P§ = new StageActor(section,CharacterRegistry.§#!P§,false,null,false,"cutscene/TrainRide/Spritesheet.png");
            if(!_loc6_)
            {
               break;
            }
         ...
         if(!_loc6_)
         {
            ...
            while(true)
            {
               if(_loc7_)
               {
                  §7W§ = new StageActor(section,CharacterRegistry.§7W§,false,null,false,"cutscene/TrainRide/Spritesheet.png");
                  if(!_loc7_)
                  {
                     break;
                  }
         ...
         while(true)
         {
            if(!_loc6_)
            {
               ...
               if(_loc7_)
               {
                  § !V§ = new StageActor(section,CharacterRegistry.duplicator,false,0.6,false,"cutscene/TrainRide/Spritesheet.png");
                  if(!_loc7_)
                  {
                     break;
                  }
            ...
            if(_loc7_)
            {
               duplicator = new StageActor(section,CharacterRegistry.duplicator,false,null,false,"cutscene/TrainRide/Spritesheet.png");
               if(!_loc6_)
               {
         ...
         while(true)
         {
            ...
            child = new StageActor(section,CharacterRegistry.child,false,null,false,"cutscene/TrainRide/Spritesheet.png");
            if(!_loc6_)
            {
               break;
            }
         ...
         while(true)
         {
            if(!_loc4_)
            {
               ...
               while(true)
               {
                  ...
                  duplicator.placeAt(8.2,-2.6,true);
      ...
      public function frame5() : void
      {
         ...
         var _loc1_:Vector.<StageActor> = sprites.splice(int(sprites.indexOf(§ !V§,0)),1);
         var _loc2_:Scene3D = tunnel.§"[§;
         var _loc3_:Model = §9p§;
         loop0:
         while(true)
         {
      ...
      public function frame23() : void
      {
         ...
         if(_loc3_)
         {
            ...
            while(true)
            {
               ...
               §7W§.placeAt(0.5,0.3,null,10);
               if(!_loc4_)
               {
                  §7W§.spritesheet.§,=§(22);
                  §7W§.spritesheet.§@S§(false);
                  duplicator.placeAt(9.8,-50.2,true);
                  duplicator.spritesheet.§,=§(52);
                  if(!_loc4_)
                  {
                     duplicator.spritesheet.§@S§(false);
      ...
      public function frame22() : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               if(_loc3_)
               {
                  duplicator.placeAt(9.8,-50,true,15);
            ...
            var _loc2_:Point3D = duplicator.transform.getPosition();
            _loc2_.x = -15;
            _loc2_.y = -60;
            _loc2_.z = 0;
            QuaternionUtils.rotateVector(BoatRide.§;D§,_loc2_,_loc2_);
            §§push(§9p§.transform);
            ...
            §§pop().§6!&§(§§pop(),§§pop(),§§pop());
            §9p§.transform.setRotation(BoatRide.§;D§);
            §9p§.update(0);
            return;
         }
         duplicator.spritesheet.§@S§(false);
      ...
      public function frame2() : void
      {
         ...
         while(true)
         {
            if(_loc2_)
            {
               duplicator.placeAt(8,-2.5,true,14);
      ...
      public function frame18() : void
      {
         ...
         var _loc2_:Point3D = tunnel.camera.§%!7§;
         while(true)
         {
            if(!_loc9_)
            {
         ...
         var _loc3_:Quaternion = tunnel.camera.§,t§;
         var _loc4_:Quaternion = BoatRide.§;D§;
         loop1:
         while(true)
         {
            while(true)
      ...
      public function frame17() : void
      {
         ...
         while(true)
         {
            ...
            {
               §7!!§.translate(0,0,250);
               tunnel.camera.translate(0,0,200);
               loop1:
               while(true)
               {
                  while(true)
      ...
      public function frame16() : void
      {
         ...
         var _loc3_:* = §§pop();
         §7!!§.translate(0,0,200);
         tunnel.camera.translate(0,0,100);
         if(!_loc3_)
         {
            tunnel.display(0);
            pastafarian.placeAt(0.4,2.4);
               ...
               while(true)
               {
                  if(!_loc3_)
                  {
                     ...
                     if(_loc4_)
                     {
                        ...
                        duplicator.placeAt(8,-1.1,true,25);
                     }
                  }
      ...
      public function frame10() : void
      {
         ...
         var _loc8_:Quaternion = §7W§.transform.getRotation();
         var _loc9_:Quaternion = new Quaternion();
         while(true)
         {
            if(_loc11_)
            {
         ...
         while(true)
         {
            if(!_loc10_)
            {
               QuaternionUtils.rotateVector(BoatRide.§;D§,_loc1_,_loc1_);
               if(_loc11_)
               {
                  §§push(§7W§.transform);
                  §§push(-_loc1_.x);
      ...
      public function frame1() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               if(!_loc1_)
               {
                  QuaternionUtils.rotateVector(BoatRide.§;D§,§4d§,§4d§);
                  QuaternionUtils.rotateVector(BoatRide.§;D§,§0-§,§0-§);
                  if(!_loc2_)
                  {
                     break;
                  }
               ...
               if(_loc2_)
               {
                  duplicator.placeAt(8,-2.3,true,18);
                  duplicator.spritesheet.§,=§(51);
                  duplicator.spritesheet.§@S§(false);
                  if(!_loc1_)
                  {
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            ...
            §`!6§();
            addr0057:
            var _loc1_:Quaternion = tunnel.camera.§,t§;
            var _loc2_:Quaternion = BoatRide.§;D§;
            while(true)
            {
               if(!_loc5_)
               {
                  ...
                  while(true)
                  {
                     while(true)
                     {
                        if(_loc4_)
                        {
                           ...
                           § !V§.spritesheet.§,=§(50);
                           § !V§.spritesheet.§@S§(false);
                           duplicator.placeAt(8,-2,true,28);
      ...
      public function §4!@§() : void
      {
         ...
         var _loc1_:Point3D = §7!!§.getPosition();
         while(true)
         {
            if(!_loc9_)
            {
         ...
         var _loc2_:Quaternion = §7!!§.getRotation();
         var _loc3_:Quaternion = _loc2_;
         while(true)
         {
            if(_loc10_)
            {
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               addr020f:
               QuaternionUtils.multiply(_loc2_,BoatRide.§;D§,_loc2_);
               break;
            }
            addr021e:
            §7!!§.setRotation(_loc2_);
            §7!!§.§3;§();
            ...
            while(true)
            {
               if(!_loc9_)
               {
                  ...
                  QuaternionUtils.setFromEuler(-1.5707963267948966,0,0,_loc7_.transform.§,t§);
                  if(!_loc10_)
                  {
                     break;
                  }
            ...
            §[c§ = new TunnelSection(tunnel,tunnel.§"[§,Vector.<Entity3D>([]),"layout-grid3x1|tileWidth-70",1,0);
            addr0338:
            return;
         }
         §§push(_loc3_.w);
      ...
      public function §8j§() : void
      {
         ...
         var _loc3_:Boolean = true;
         var _loc4_:* = §§pop();
         var _loc1_:CharacterDef = child.§!8§;
         var _loc2_:CharacterDef = child.§!8§;
         while(true)
         {
            if(_loc3_)
            {
      ...
      public function §8E§(param1:StageActor) : void
      {
         §§push(false);
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
