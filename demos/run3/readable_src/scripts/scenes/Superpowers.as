package scenes
{
   ...
   public class Superpowers extends §+Z§
   {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  while(true)
                  {
                     ...
                     pastafarian.placeAt(10,88.9,null,-2);
                     if(!_loc7_)
                     {
                        break loop9;
                     }
      ...
      public function frame6() : void
      {
         ...
         pastafarian.placeAt(9.6,85.7,null,-11);
         addr008b:
         ...
         while(true)
         {
            ...
            while(true)
            {
               ...
               while(true)
               {
                  ...
                  addr024c:
                  §#!P§.placeAt(10,90.3,null,1);
                  §#!P§.spritesheet.§,=§(28);
                  §#!P§.spritesheet.§@S§(false);
                  if(_loc7_)
                  {
                     pastafarian.placeAt(9.6,84.6,null,16);
                  }
                  break;
               }
               addr0288:
      ...
      public function frame20() : void
      {
         ...
         if(_loc4_)
         {
            ...
            pastafarian.placeAt(10.1,89.5,null,1);
            while(true)
            {
               if(!_loc3_)
               {
         ...
         if(§§pop() == 0)
         {
            ...
            if(!_loc11_)
            {
               ...
               while(true)
               {
                  if(_loc10_)
                  {
                     pastafarian.placeAt(10.1,89.7,null,-1);
                     if(_loc11_)
                     {
                        break;
                     }
      ...
      public function frame16() : void
      {
         ...
         tunnel.display(0);
         child.model.§#"§(false);
         §#!P§.placeAt(9.9,90.3,null,-3);
         §#!P§.spritesheet.§,=§(68);
         §#!P§.spritesheet.§@S§(true);
         if(_loc8_)
         {
            pastafarian.placeAt(10,89.7,null,-1);
