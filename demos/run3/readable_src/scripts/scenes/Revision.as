   ...
   public class Revision extends §+Z§
   {
      ...
      override public function loadNext(param1:Boolean, param2:Boolean) : void
      {
         ...
         while(true)
         {
            ...
            _loc3_ = CharacterRegistry.gentleman;
            _loc4_ = null;
            loop1:
            while(true)
            {
      ...
      public function frame4() : void
      {
         ...
         var _loc2_:Quaternion = _loc1_.transform.getRotation();
         ...
         while(true)
         {
            ...
            §§pop().w = §§pop();
            addr0233:
            QuaternionUtils.multiply(_loc2_,_loc3_,_loc2_);
            if(!_loc7_)
            {
               _loc1_.transform.setRotation(_loc2_);
               §%!'§.§[B§(_loc1_);
               addr0257:
               §,!J§ = 0.75;
            }
      ...
      public function frame34() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               gentleman.placeAt(15.8,30,null,-70);
               if(_loc2_)
               {
                  break;
               }
      ...
      public function frame33() : void
      {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               gentleman.placeAt(16.2,29.4,null,-30);
               if(_loc2_)
               {
                  break;
               }
      ...
      public function frame28() : void
      {
         ...
         if(_loc1_)
         {
            gentleman.placeAt(17.1,28.2,null,-5);
            if(_loc1_)
            {
               gentleman.spritesheet.§,=§(82);
               while(true)
      ...
      public function frame26() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               if(_loc1_)
               {
                  gentleman.placeAt(17.8,28.2,null,-11);
                  if(!_loc1_)
                  {
                     break;
                  }
