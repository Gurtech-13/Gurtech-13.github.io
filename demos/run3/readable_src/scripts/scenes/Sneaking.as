   ...
   public class Sneaking extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         if(_loc2_)
         {
            ...
            if(!_loc3_)
            {
               §#!P§.transform.setRotation(child.transform.getRotation());
            }
         }
      }
      ...
      public function frame8() : void
      {
         ...
         §#!P§.placeAt(17.8,-43.2,true);
         §#!P§.spritesheet.§,=§(28);
         §#!P§.spritesheet.§@S§(true);
         child.placeAt(16.2,-33,true);
         child.spritesheet.§,=§(119);
      ...
      public function frame5() : void
      {
         ...
         §#!P§.spritesheet.§,=§(46);
         §#!P§.spritesheet.§@S§(false);
         child.placeAt(16.2,-30.4,true,-22);
         if(!_loc3_)
         {
