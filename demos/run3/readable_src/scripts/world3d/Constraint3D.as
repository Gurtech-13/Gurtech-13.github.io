package world3d
{
   ...
   public class Constraint3D implements §@[§
   {
      ...
      public var physicsData3D:Physics3D;
      ...
      public function Constraint3D(param1:Entity3D)
      {
         §§push(false);
         ...
         while(true)
         {
            while(true)
            {
               ...
               §§push(§§findproperty(Physics3D));
               §§push(param1.world.§6!=§());
               if(!_loc3_)
               {
                  §§push(Number(§§pop()));
               }
               §§pop().physicsData3D = new §§pop().Physics3D(§§pop());
               break;
            }
      ...
      public function update(param1:Number) : void
      {
         ...
         var _loc3_:Point3D = _loc2_.getPosition();
         loop1:
         while(true)
         {
            while(true)
      ...
      public function §0!b§(param1:Entity3D, param2:Number) : void
      {
         var _temp_1:* = false;
      ...
      public function §3o§(param1:Number, param2:Entity3D) : void
      {
         var _temp_1:* = true;
         ...
         if(_loc11_)
         {
                     ...
                     if(_loc11_)
                     {
                        ...
                        if(!_loc10_)
                        {
                           ...
                           if(§!K§.transform.§=0§ != null)
                           {
                              ...
                              QuaternionUtils.rotateVector(§!K§.transform.§=0§.§<!A§(),§"^§,§"^§);
                           }
                        }
                        §[!K§(§"^§.x,§"^§.y,§"^§.z);
                     }
            ...
            _loc6_ = §"^§;
            _loc8_ = §!K§.transform.getPosition();
            if(!_loc10_)
            {
               §§push(_loc3_.§]!R§);
               if(!_loc10_)
