package §6!Q§
{
   ...
   public class §+;§ extends §&l§
   {
      ...
      public function §+;§(param1:Object = undefined, param2:Object = undefined, param3:Object = undefined)
      {
         ...
         var _loc15_:* = null as Vector.<CharacterDef>;
         var _loc16_:* = null as CharacterDef;
         ...
         if(!_loc23_)
         {
            ...
            while(true)
            {
               §§push(int(CharacterRegistry.§&!#§.length));
               if(_loc22_)
               {
                  §§push(int(§§pop()));
                  if(!_loc23_)
         ...
         var _loc11_:Vector.<CharacterDef> = new Vector.<CharacterDef>(0,false);
         var _loc12_:Vector.<CharacterDef> = _loc11_;
         if(_loc22_)
         {
            §§push(0);
            if(!_loc23_)
                           ...
                           while(true)
                           {
                              while(true)
                              {
                                 ...
                                 if(_loc22_)
                                 {
                                    ...
                                    §§push(_loc14_ == CharacterRegistry.random);
                                    if(!_loc22_)
                                    {
                                       break loop15;
                                    }
                  ...
                  while(true)
                  {
                     ...
                     while(true)
                     {
                        if(!_loc23_)
                        {
                           ...
                           if(_loc22_)
                           {
                              if(_loc14_ != CharacterRegistry.lizard)
                              {
                                 §§push(§§findproperty(§?P§));
                                 §§push(_loc14_);
                                 §§push(global);
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              §§push(int(_loc14_.§[P§.§@D§.indexOf(CharacterRegistry.§;<§,0)) < 0);
                              break loop25;
                           }
                           if(§§pop())
                           {
      ...
      public function §8t§(param1:CharacterDef, param2:Object = undefined) : void
      {
         §§push(false);
                                                                  ...
                                                                  while(true)
                                                                  {
                                                                     while(true)
                                                                     {
                                                                        if(§§pop())
                                                                        {
                                                                           ...
                                                                           §§pop();
                                                                           §§push(_loc10_.character != CharacterRegistry.random);
                                                                           if(!_loc12_)
                                                                           {
                                                                              break loop26;
                                                                           }
      ...
      override public function reset() : void
      {
            ...
            if(!_loc6_)
            {
               ...
               while(true)
               {
                  if(_loc7_)
                  {
                     ...
                     if(§§pop())
                     {
                        §8t§(CharacterRegistry.§&!#§[0]);
                     }
                     else
                     {
                        §8t§(CharacterRegistry.§;<§);
                        if(!_loc7_)
                        {
                           break;
                        }
         ...
         var _loc4_:Level = Main.instance.tunnel;
         loop6:
         while(true)
         {
            loop7:
      ...
      public function §7]§(param1:CharacterDef, param2:Event) : void
      {
         var _temp_1:* = true;
      ...
      public function §-k§() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc3_:* = null as §?P§;
         var _loc5_:* = null as Vector.<CharacterDef>;
                        ...
                        while(true)
                        {
                           ...
                           if(_loc7_)
                           {
                              ...
                              if(!_loc8_)
                              {
                                 ...
                                 §§push(§=#§.character == CharacterRegistry.random);
                                 if(!_loc7_)
                                 {
                                    break loop6;
                                 }
