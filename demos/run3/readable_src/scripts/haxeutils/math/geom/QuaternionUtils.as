package haxeutils.math.geom
{
   public class QuaternionUtils
   {
      ...
      public static var scratch:Point3D;
      
      public function QuaternionUtils()
      {
      }
      
      public static function multiply(param1:Quaternion, param2:Quaternion, param3:Quaternion = undefined) : Quaternion
      {
         var _temp_1:* = false;
      ...
      public static function rotateVector(param1:Quaternion, param2:Point3D, param3:Point3D = undefined) : Point3D
      {
         var _temp_1:* = false;
         var _loc12_:Boolean = true;
         var _loc13_:Boolean = _temp_1;
      ...
      public static function §?!A§(param1:Point3D, param2:Point3D, param3:Quaternion = undefined) : Quaternion
      {
         var _temp_1:* = true;
                                          ...
                                          while(true)
                                          {
                                             if(!_loc10_)
                                             {
                                                ...
                                                else
                                                {
                                                   ...
                                                   {
                                                      Point3DUtils.§ !K§(param1.x,param1.y,param1.z,param2.x,param2.y,param2.z,QuaternionUtils.scratch);
                                                      if(!_loc10_)
                                                      {
                                                         param3.x = QuaternionUtils.scratch.x;
                                                         param3.y = QuaternionUtils.scratch.y;
                                                         if(!_loc10_)
                                                         {
                                                            addr054c:
                                                            param3.z = QuaternionUtils.scratch.z;
                                                            if(_loc10_)
                                                            {
                                                               break loop14;
                                                            }
      ...
      public static function fromAxes(param1:Point3D, param2:Point3D, param3:Quaternion = undefined) : Quaternion
      {
         var _temp_1:* = false;
         ...
         _loc6_ = QuaternionUtils.scratch;
         loop12:
         while(true)
         {
            while(true)
      ...
      public static function toAxisAngle(param1:Quaternion, param2:AxisAngle = undefined) : AxisAngle
      {
         var _temp_1:* = false;
      ...
      public static function setFromEuler(param1:Number, param2:Number, param3:Number, param4:Quaternion = undefined) : Quaternion
      {
         var _temp_1:* = false;
      ...
      public static function slerp(param1:Quaternion, param2:Quaternion, param3:Number, param4:Quaternion = undefined) : Quaternion
      {
         var _temp_1:* = true;
