package haxeutils.math.geom
{
   ...
   public class Matrix3D
   {
      ...
      public static function multiplyInto(param1:Vector.<Number>, param2:Vector.<Number>, param3:Vector.<Number>) : void
      {
         /*
          * Decompilation error
      ...
      public function §%V§(param1:Number, param2:Point3D, param3:Point3D = undefined) : void
      {
         ...
         Matrix3D.multiplyInto(rawData,Matrix3D.§;m§.rawData,rawData);
         addr0069:
      }
   }
}
