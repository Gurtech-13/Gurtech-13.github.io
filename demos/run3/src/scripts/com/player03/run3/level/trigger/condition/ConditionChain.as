package com.player03.run3.level.trigger.condition
{
   ...
   public class ConditionChain extends §,!A§
   {
      ...
      public function ConditionChain(param1:Vector.<§#!G§>, param2:Vector.<int>, param3:Boolean, param4:§<!§, param5:§ !W§, param6:Object)
      {
         §§push(false);
      ...
      public function §4!3§(param1:§ !W§) : Boolean
      {
         var _temp_1:* = true;
      ...
      public function §6!T§(param1:§ !W§) : Boolean
      {
         var _temp_1:* = true;
