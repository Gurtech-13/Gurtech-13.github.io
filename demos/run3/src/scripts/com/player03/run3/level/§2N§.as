package com.player03.run3.level
{
   ...
   public class §2N§ implements §[!M§
   {
      ...
      public function §2N§(param1:§ !W§, param2:§>W§, param3:§>W§, param4:Number, param5:Point3D = undefined, param6:§"B§ = undefined, param7:Object = undefined)
      {
         §§push(false);
      ...
      public static function §'!'§(param1:§ !W§, param2:Vector.<Point3D>, param3:Number, param4:int, param5:Point3D = undefined, param6:§"B§ = undefined, param7:Object = undefined) : §2N§
      {
         if(param7 == null)
         {
            param7 = true;
      ...
      public static function §#^§(param1:§ !W§, param2:String, param3:int, param4:Point3D = undefined, param5:§"B§ = undefined, param6:Object = undefined) : §2N§
      {
         §§push(false);
         ...
         var _loc7_:Layout3D = §§pop().§&!`§(§§pop());
         var _loc8_:§&B§ = _loc7_.§4L§();
         §§push(§`!3§);
