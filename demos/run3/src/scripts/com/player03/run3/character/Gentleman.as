package com.player03.run3.character
{
   ...
   public class Gentleman extends §6M§
   {
      ...
      public function Gentleman(param1:§ !W§, param2:§6O§)
      {
         var _temp_1:* = true;
      ...
      override public function §%9§(param1:§%!§, param2:Point3D) : Boolean
      {
         §§push(false);
