package com.player03.run3.character
{
   ...
   public class §6O§
   {
      ...
      public function §6O§(param1:int, param2:String, param3:int, param4:Function, param5:Object = undefined, param6:String = undefined)
      {
         var _temp_1:* = true;
      ...
      public function §2!F§(param1:§ !W§) : §6M§
      {
         var _temp_1:* = true;
      ...
      public function §1!L§(param1:§ !W§) : §6M§
      {
         return §-!X§(param1,this);
      }
