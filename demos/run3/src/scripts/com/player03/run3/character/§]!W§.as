package com.player03.run3.character
{
   ...
   public class §]!W§
   {
      ...
      public var §@D§:Vector.<§6O§>;
      
      public var §>v§:§9t§;
      
      public function §]!W§(param1:Vector.<§6O§>)
      {
         var _temp_1:* = true;
      ...
      public static function create(param1:Vector.<§6O§>) : void
      {
         var _temp_1:* = true;
         var _loc5_:Boolean = false;
         var _loc6_:Boolean = _temp_1;
      ...
      public function §`Z§(param1:§6O§) : §6O§
      {
         var _temp_1:* = true;
