   ...
   public class §!>§
   {
      ...
      public static function init() : void
      {
         ...
         while(true)
         {
            ...
            var _loc2_:§6O§ = §'O§.§-P§;
            var _loc3_:§6O§ = §'O§.skater;
            var _loc4_:§6O§ = §'O§.student;
            var _loc5_:§6O§ = §'O§.§#!P§;
            var _loc6_:§6O§ = §'O§.lizard;
            var _loc7_:§6O§ = §'O§.duplicator;
            var _loc8_:§6O§ = §'O§.§7W§;
            var _loc9_:§6O§ = §'O§.child;
            var _loc10_:§6O§ = §'O§.gentleman;
            var _loc11_:§6O§ = §'O§.pastafarian;
            loop1:
            while(true)
            {
               loop2:
