package §>T§
{
   ...
   public class §-2§ extends §%!§
   {
      ...
      public function §-2§(param1:§=2§, param2:Point3D, param3:Point3D, param4:Point3D, param5:int, param6:int, param7:int, param8:§'H§ = undefined)
      {
         /*
          * Decompilation error
      ...
      public function §`!N§(param1:§"B§, param2:Point3D, param3:Point3D = undefined) : void
      {
         §§push(false);
         ...
         while(true)
         {
            ...
            while(true)
            {
               while(true)
               {
                  ...
                  §4!R§.§@!M§(param1,axis1.origin,axis1.origin);
                  §4!R§.§@!M§(param1,axis2.origin,axis2.origin);
                  §4!R§.§@!M§(param1,axis3.origin,axis3.origin);
                  if(!_loc15_)
                  {
                     break loop3;
                  }
               ...
               §4!R§.§@!M§(param1,axis3.normal,axis3.normal);
               §4!R§.§@!M§(param1,p1,p1);
               §4!R§.§@!M§(param1,p2,p2);
               §4!R§.§@!M§(param1,p3,p3);
               ...
               §§pop()[§§pop()] = _loc12_;
               §4!R§.§@!M§(param1,§;!C§.normal,§;!C§.normal);
               if(param3 != null)
               {
                  _loc6_ = _loc5_;
                  loop8:
            ...
            §4!R§.§@!M§(param1,axis1.normal,axis1.normal);
            addr0276:
            §4!R§.§@!M§(param1,axis2.normal,axis2.normal);
            break loop4;
         }
         while(true)
         {
