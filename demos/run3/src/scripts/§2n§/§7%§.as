package §2n§
{
   ...
   public class §7%§ extends §'!O§ implements §,D§, §+<§
   {
      ...
      public function show(param1:Vector.<§6O§>, param2:Function, param3:Function) : void
      {
         §§push(false);
         ...
         var _loc17_:* = null as Vector.<§6O§>;
         var _loc18_:* = null as §6O§;
         loop2:
         while(true)
         {
            while(true)
                  ...
                  else
                  {
                     ...
                     while(true)
                     {
                        ...
                        while(true)
                        {
                           ...
                           §§push(_loc16_.character == §'O§.random);
                           if(_loc20_)
                           {
                              break;
                           }
      ...
      public function §'k§(param1:§6O§) : void
      {
         §§push(false);
         ...
         while(true)
         {
            ...
            §§push(int(§'O§.available.indexOf(param1,0)));
            if(_loc12_)
            {
               §§push(int(§§pop()));
            }
      ...
      public function §"!`§(param1:§6O§, param2:MouseEvent) : void
      {
         var _temp_1:* = true;
      ...
      override public function §^g§() : void
      {
         ...
         var _loc6_:* = §§pop();
         var _loc7_:Vector.<§6O§> = §'O§.available;
         while(true)
         {
            if(_loc17_)
            {
