package § 0§
{
   ...
   public class §>!0§ extends §>!,§ implements §+<§
   {
      ...
      public function §>!0§()
      {
         ...
         §§push([new §#!G§(function(param1:§ !W§):Number
         {
            var _temp_1:* = false;
         ...
         while(true)
         {
            ...
            §=! §(null,function(param1:§<!§, param2:§ !W§, param3:Object):ConditionChain
            {
      ...
      override public function §@B§(param1:§ !W§, param2:§,!A§, param3:Object = undefined) : void
      {
         var _temp_1:* = true;
