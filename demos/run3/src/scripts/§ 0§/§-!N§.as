package § 0§
{
   ...
   public class §-!N§ extends § !W§
   {
      ...
      public function §-!N§(param1:§1!&§ = undefined)
      {
         ...
         var _loc7_:Vector.<§6O§> = new Vector.<§6O§>(0,false);
         loop7:
         while(true)
         {
            while(true)
      ...
      public function §2'§(param1:§6M§, param2:§6O§) : Boolean
      {
         var _temp_1:* = true;
         ...
         var _loc4_:Vector.<§6O§> = §'O§.available;
         loop3:
         while(true)
         {
            loop4:
      ...
      override public function §+,§(param1:§6O§) : §6M§
      {
         var _temp_1:* = true;
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = _temp_1;
         ...
         while(true)
         {
            while(true)
            {
               ...
               §'O§.random.§4!a§(null,§9!H§);
               break loop0;
            }
            return super.§+,§(param1);
         }
         param1 = §'O§.random.character;
         break loop1;
      }
      ...
      public function §[6§(param1:§6M§) : void
      {
         §§push(false);
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
      ...
      override public function §#!§(param1:§6M§) : void
      {
         var a11:§6M§;
         var f1:Function;
         var a1:§6M§;
