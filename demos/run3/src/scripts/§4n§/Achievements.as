   ...
   public class Achievements
   {
      ...
      public static function init() : void
      {
         ...
         if(!_loc14_)
         {
            ...
            if(_loc15_)
            {
               Achievements.§7N§ = new Achievement(22,"I Would Bounce 500 More","Starting at any point after the 500m mark, travel 500 meters in a row with the jump button held.",250,"achievement/IWouldBounce500More.png",§'O§.§7W§,null,0);
            }
         }
         ...
         while(true)
         {
            if(_loc15_)
            {
               ...
               if(_loc15_)
               {
                  Achievements.§3!-§ = new Achievement(23,"Falling to Pieces","Let 50 duplicates fall into space in one Infinite Mode run.",500,"achievement/FallingToPieces.png",§'O§.duplicator,null,0);
                  if(_loc14_)
                  {
                     break;
                  }
            ...
            Achievements.§3!-§.§`p§ = §%z§.MODE_WITH_CHARACTER(§,a§.INFINITE,§'O§.duplicator);
            break;
         }
         _loc2_ = Achievements.§3!-§;
         while(true)
