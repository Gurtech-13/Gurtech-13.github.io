package nme3D
{
   ...
   public class §1![§ implements §@[§
   {
      ...
      public static var §?!C§:§4!V§;
      
      public var §1`§:Matrix3D;
      ...
      public function §1![§(param1:Object = undefined)
      {
         var _temp_1:* = true;
         ...
         while(true)
         {
            ...
            if(_loc4_)
            {
               Matrix3D.§-!1§(_loc2_.rawData,Context3DUtils.§6!§.rawData,_loc2_.rawData);
            }
            addr00f0:
            §]'§ = new Vector3D();
            break;
      ...
      public function §8!"§(param1:Point3D, param2:Point3D = undefined) : Point3D
      {
         §§push(false);
         ...
         if(_loc4_)
         {
            Matrix3D.§-!1§(_loc3_.rawData,§1`§.rawData,_loc3_.rawData);
         }
         _loc3_ = §1![§.§?!C§;
         Matrix3D.§-!1§(_loc3_.rawData,§-4§.rawData,_loc3_.rawData);
         §1![§.§?!C§.invert();
         if(_loc4_)
         {
            §1![§.§?!C§.transformVector3Into4(param1,§]'§);
         }
         §]'§.project();
         if(_loc4_)
         {
            ...
            if(§%a§)
            {
               if(!_loc5_)
               {
                  ...
                  while(true)
                  {
                     ...
                     if(_loc6_)
                     {
                        Matrix3D.§-!1§(_loc4_.rawData,§1`§.rawData,_loc4_.rawData);
                     }
                     _loc4_ = §1![§.§?!C§;
                     if(_loc6_)
                     {
                        Matrix3D.§-!1§(_loc4_.rawData,§-4§.rawData,_loc4_.rawData);
                        if(!_loc5_)
                        {
                           §%a§ = false;
                        }
