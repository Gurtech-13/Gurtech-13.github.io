package §@!^§
{
   ...
   public class §2+§ extends §6O§
   {
      
      public var character:§6O§;
      ...
      public function §4!a§(param1:Vector.<String> = undefined, param2:Vector.<§6O§> = undefined) : void
      {
         §§push(false);
         ...
         var _loc7_:int = 0;
         var _loc8_:* = null as Vector.<§6O§>;
         var _loc9_:* = null as §6O§;
         §§push([]);
         if(_loc10_)
         {
            §§push(§§pop());
         ...
         var _loc4_:* = §§pop();
         var _loc5_:Vector.<§6O§> = §'O§.available;
         if(!_loc11_)
         {
            loop0:
            while(true)
      ...
      override public function §2!F§(param1:§ !W§) : §6M§
      {
         var _temp_1:* = true;
