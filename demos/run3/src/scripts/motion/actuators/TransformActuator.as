package motion.actuators
{
   ...
   public class TransformActuator extends SimpleActuator
   {
      ...
      public function TransformActuator(param1:Object, param2:Number, param3:*)
      {
      ...
      override public function update(param1:Number) : void
      {
         ...
         if(endColorTransform != null)
         {
            ...
            if(Reflect.hasField(_loc4_,"colorTransform"))
            {
      ...
      override public function apply() : void
      {
         ...
         if(endColorTransform != null)
         {
            ...
            if(Reflect.hasField(_loc3_,"colorTransform"))
            {
