package motion.actuators
{
   ...
   public class MotionPathActuator extends SimpleActuator
   {
      ...
      public function MotionPathActuator(param1:Object, param2:Number, param3:*)
      {
         ...
         if(!paused)
         {
            ...
            if(_loc4_ == 1)
            {
               if(_repeat == 0)
               {
                  ...
                  {
                     _loc10_ = target;
                     if(Reflect.hasField(_loc10_,"visible"))
                     {
                        _loc10_["visible"] = false;
                     }
                     else
                     {
                        Reflect.setProperty(_loc10_,"visible",false);
                     }
                  }
                  complete(true);
                  return;
      ...
      override public function apply() : void
      {
         ...
         while(_loc1_ < int(_loc2_.length))
         {
            ...
            _loc1_++;
            Reflect.setProperty(target,_loc3_,Reflect.field(properties,_loc3_).§9z§());
         }
      }
   }
}
