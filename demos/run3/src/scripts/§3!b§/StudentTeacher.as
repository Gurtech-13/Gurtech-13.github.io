package §3!b§
{
   ...
   public class StudentTeacher extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         var _loc4_:* = §§pop();
         var _loc1_:Point3D = student.transform.§<!C§();
         ...
         if(!_loc4_)
         {
            ...
            if(!_loc4_)
            {
               _loc2_.sprite.§!C§.registerAnimation(_loc2_);
            }
         }
      }
      ...
      public function frame12() : void
      {
         ...
         while(true)
         {
            ...
            §4_§ = new §4S§(§'O§.gentleman,gentleman.spritesheet,tunnel.§"[§);
      ...
      public function frame11() : void
      {
         ...
         while(true)
         {
            if(_loc5_)
            {
               ...
               if(_loc5_)
               {
                  _loc1_.sprite.§!C§.registerAnimation(_loc1_);
                  if(!_loc5_)
                  {
                     break;
                  }
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            if(_loc3_)
            {
               §4!R§.§1!A§(3.141592653589793,1.5707963267948966,0,tunnel.§<!M§.§,t§);
               if(_loc3_)
               {
                  tunnel.§<!M§.reset();
                  tunnel.§<!M§.§6!&§(90,0,830);
