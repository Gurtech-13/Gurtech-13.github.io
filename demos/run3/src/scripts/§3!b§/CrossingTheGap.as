      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               if(!_loc2_)
               {
                  §4!R§.§1!A§(0,-3.392920065876977,0,tunnel.§<!M§.§,t§);
                  tunnel.§<!M§.reset();
                  tunnel.§<!M§.§6!&§(10,-71,-90);
                  if(!_loc3_)
                  {
