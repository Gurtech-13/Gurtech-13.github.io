package §3!b§
{
   ...
   public class Insanity extends §+Z§
   {
      ...
      public function frame15() : void
      {
         ...
         var _loc4_:* = §§pop();
         tunnel.§<!M§.translate(0,0,550);
         tunnel.display(0);
         §-P§.§9E§(5,31,true,-97);
         §-P§.transform.rotate(§4!R§.§1!A§(0,0.3141592653589793,0));
         §-P§.spritesheet.§,=§(74);
      ...
      public function frame14() : void
      {
         ...
         while(true)
         {
            ...
            §-P§.transform.rotate(§4!R§.§1!A§(0,1.5707963267948966,0));
            break;
         }
      }
      ...
      public function frame10() : void
      {
         ...
         while(true)
         {
            if(!_loc5_)
            {
               ...
               §-P§.transform.rotate(§4!R§.§1!A§(0,3.7699111843077517,0));
               if(!_loc4_)
               {
                  break;
               }
      ...
      public function frame0() : void
      {
         ...
         var _loc2_:Boolean = false;
         var _loc3_:Boolean = _temp_1;
         §,4§ = new §4S§(§'O§.§-P§,§-P§.spritesheet,tunnel.§"[§);
         ...
         §4!R§.§1!A§(0,0.3141592653589793,0,tunnel.§<!M§.§,t§);
         tunnel.§<!M§.reset();
         if(!_loc2_)
         {
            tunnel.display(0);
               ...
               if(_loc3_)
               {
                  ...
                  if(!_loc2_)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        §4!R§.§9!L§(_loc1_.transform.§,t§,§4!R§.§1!A§(-0.3141592653589793,0,0),_loc1_.transform.§,t§);
