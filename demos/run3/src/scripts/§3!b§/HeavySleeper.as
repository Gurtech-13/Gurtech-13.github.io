package §3!b§
{
   ...
   public class HeavySleeper extends §+Z§
   {
      ...
      override public function unloadLevel() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               if(_loc1_)
               {
                  tunnel.§<!M§.§`F§(false,false);
                  if(!_loc1_)
                  {
                     break;
                  }
                  tunnel.§<!M§.§'!=§(false,false);
                  if(!_loc1_)
                  {
                     break loop0;
                  }
      ...
      public function frame4() : void
      {
         ...
         lizard.§9E§(6.6,74.5,null,-7);
         if(_loc4_)
         {
            lizard.spritesheet.§,=§(66);
         }
         lizard.spritesheet.§@S§(false);
         skater.§9E§(7.2,74.9,null,-3);
         if(_loc4_)
         {
      ...
      public function frame22() : void
      {
         ...
         if(!_loc11_)
         {
            tunnel.§<!M§.§7#§(_loc1_,-393,-117,2320).ease(Expo.§<y§());
         }
         var _loc2_:Transform = tunnel.§<!M§;
         var _loc3_:§"B§ = null;
         while(true)
         {
            if(_loc10_)
      ...
      public function frame17() : void
      {
         ...
         var _loc1_:Boolean = false;
         var _loc2_:Boolean = _temp_1;
         tunnel.§<!M§.§`F§(true,false);
         tunnel.§<!M§.§'!=§(true,false);
         lizard.§9E§(2.8,34.9,null,65);
         if(!_loc1_)
         {
      ...
      public function frame16() : void
      {
         ...
         if(!_loc8_)
         {
            tunnel.§<!M§.§7#§(_loc1_,512,-116,2556).ease(Expo.§<y§());
         }
         var _loc2_:Transform = tunnel.§<!M§;
         var _loc3_:§"B§ = null;
         while(true)
      ...
      public function frame12() : void
      {
         ...
         if(_loc6_)
         {
            ...
            §§pop().§+!P§ = §§pop();
            lizard.§9E§(7.5,74.5,null,-20);
            if(!_loc7_)
            {
               lizard.spritesheet.§,=§(4);
               lizard.spritesheet.§@S§(false);
               skater.§9E§(6.2,-8,null,-15);
            }
      ...
      public function frame11() : void
      {
         ...
         while(true)
         {
            ...
            skater.§9_§ = tunnel.§]!#§(skater.transform.position.z,true);
            break;
         }
         var _loc1_:Number = 3;
         if(_loc11_)
         {
            tunnel.§<!M§.§7#§(_loc1_,tunnel.§<!M§.position.x + 320,tunnel.§<!M§.position.y,tunnel.§<!M§.position.z - 300);
         }
         var _loc2_:Transform = tunnel.§<!M§;
         var _loc3_:§"B§ = null;
         while(true)
