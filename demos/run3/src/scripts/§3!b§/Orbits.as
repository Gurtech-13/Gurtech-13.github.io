   ...
   public class Orbits extends §+Z§
   {
      ...
      public function frame0() : void
      {
         ...
         if(!_loc10_)
         {
            ...
            if(!_loc10_)
            {
               §4!R§.§1!A§(3.141592653589793,0.5235987755982988,-0.05235987755982988,tunnel.§<!M§.§,t§);
            }
         }
         var _loc6_:Point3D = new Point3D(0,65,0);
         §4!R§.§@!M§(tunnel.§<!M§.§,t§,_loc6_,_loc6_);
         tunnel.§<!M§.§%!7§.x = _loc6_.x;
         tunnel.§<!M§.§%!7§.y = _loc6_.y;
         while(true)
         {
            §§push(tunnel.§<!M§.§%!7§);
            §§push(§9_§.endZ);
