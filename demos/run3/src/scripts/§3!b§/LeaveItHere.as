package §3!b§
{
   ...
   public class LeaveItHere extends §+Z§
   {
      ...
      public function frame9() : void
      {
         ...
         if(!_loc5_)
         {
            §-P§.§9E§(13,50.2,null,70);
            if(!_loc5_)
            {
               §-P§.spritesheet.§,=§(46);
               if(!_loc5_)
               {
                  §-P§.transform.rotate(§4!R§.§1!A§(0,-1.5707963267948966,0,§9N§));
               }
            }
         }
         var _loc1_:§"B§ = §9N§;
         var _loc2_:§"B§ = §-P§.transform.§+n§();
         while(true)
         {
            if(!_loc5_)
            {
      ...
      public function frame8() : void
      {
         ...
         §-P§.transform.rotate(§4!R§.§1!A§(0,2.199114857512855,0,§9N§));
         if(_loc2_)
         {
            addr0066:
            ...
            if(!_loc2_)
            {
               ...
               if(!_loc2_)
               {
                  ...
                  while(true)
                  {
                     ...
                     §-P§.transform.rotate(§4!R§.§1!A§(0,0.18849555921538758,0,§9N§));
                     break;
                  }
               }
            }
      ...
      public function frame12() : void
      {
         ...
         while(true)
         {
            ...
            if(!_loc13_)
            {
               ...
               if(_loc14_)
               {
                  §-P§.transform.rotate(§4!R§.§1!A§(0,-0.7853981633974483,0));
               }
            }
            break loop10;
         }
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            ...
            box.transform.§"I§(§4!R§.§1!A§(0,-0.9424777960769379,0));
            if(_loc7_)
            {
