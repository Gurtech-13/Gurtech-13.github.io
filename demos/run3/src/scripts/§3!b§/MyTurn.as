package §3!b§
{
   ...
   public class MyTurn extends §+Z§
   {
      ...
      public static function §0k§(param1:§^s§, param2:TunnelSection, param3:Number, param4:Number, param5:Object = undefined, param6:Object = undefined, param7:Number = 0) : void
      {
         §§push(false);
         ...
         while(true)
         {
            ...
            param1.§9E§(int(Math.round(param3)),int(Math.floor(param4)),param5);
            break;
         }
         ...
         while(true)
         {
            ...
            addr00c0:
            var _loc9_:§"B§ = param1.transform.§+n§();
            while(true)
            {
               if(_loc13_)
               {
               ...
               param1.transform.§"I§(_loc9_);
               if(!_loc14_)
               {
                  break;
               }
               var _loc10_:Point3D = param1.transform.§<!C§();
            ...
            §4!R§.§@!M§(_loc9_,MyTurn.offset,MyTurn.offset);
            continue loop4;
         }
         loop7:
         while(true)
      ...
      public function frame5() : void
      {
         ...
         var _loc3_:* = §§pop();
         tunnel.§<!M§.§6!&§(§+!V§.x,§+!V§.y,10000 + §"J§ * 300);
         loop0:
         while(true)
         {
            while(true)
            {
               ...
               {
                  tunnel.display(0);
                  MyTurn.§0k§(§-P§,§9_§,3.8,39,false,false,15);
                  if(!_loc2_)
                  {
                     break;
                  }
      ...
      public function frame3() : void
      {
         ...
         tunnel.§<!M§.§6!&§(§+!V§.x,§+!V§.y,10000 + §"J§ * 300);
         tunnel.display(0);
         MyTurn.§0k§(§#!P§,§9_§,3.85,36.5,null,null,15);
         if(_loc2_)
         {
            §#!P§.spritesheet.§,=§(0);
            MyTurn.§0k§(§-P§,§9_§,4.07,37,null,null,-15);
            §-P§.spritesheet.§,=§(22);
         }
         while(true)
         {
               ...
               while(true)
               {
                  if(!_loc3_)
                  {
                     ...
                     if(!_loc3_)
                     {
                        ...
                        MyTurn.§0k§(§-P§,§9_§,4.05,36,null,null,10);
                        if(_loc3_)
                        {
                           break loop0;
                        }
      ...
      public function frame0() : void
      {
         ...
         while(true)
         {
            while(true)
            {
               if(!_loc4_)
               {
                  §4!R§.§1!A§(0,-0.37399912542735625,0,tunnel.§<!M§.§,t§);
                  if(!_loc4_)
                  {
                     tunnel.§<!M§.reset();
                     if(_loc4_)
               ...
               MyTurn.§0k§(§#!P§,§9_§,3.85,33.6);
               §#!P§.spritesheet.§,=§(46);
               if(!_loc4_)
               {
                  MyTurn.§0k§(§-P§,§9_§,4.05,34);
                  §-P§.spritesheet.§,=§(29);
                  break;
               }
               break loop0;
