package §3!b§
{
   ...
   public class FriendlyGreeting extends §+Z§
   {
      ...
      override public function init() : void
      {
         ...
         while(true)
         {
            if(_loc10_)
            {
               ...
               if(!_loc9_)
               {
                  duplicator = new §^s§(§9_§,§'O§.duplicator,true,null,false,null);
                  if(!_loc10_)
                  {
                     break;
                  }
      ...
      public function frame5() : void
      {
         ...
         pastafarian.§9E§(4.3,1.2);
         if(_loc3_)
         {
            pastafarian.spritesheet.§,=§(101);
         }
         duplicator.§9E§(14.7,31.5,null,1);
         ...
         while(true)
         {
            if(_loc3_)
            {
               ...
               if(!_loc2_)
               {
                  ...
                  duplicator.§9E§(14.7,31.6,null,1);
               }
            ...
            if(_loc4_)
            {
               ...
               while(true)
               {
                  if(!_loc5_)
                  {
                     ...
                     if(!_loc5_)
                     {
                        duplicator.§9E§(14.7,31.8,null,1);
