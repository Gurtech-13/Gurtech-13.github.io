   ...
   public class AngelVsBunny extends §+Z§
   {
      ...
      override public function init() : void
      {
         ...
         while(true)
         {
            ...
            §7W§ = new §^s§(§9_§,§'O§.§7W§,false,null,false,null);
            if(!_loc6_)
            {
               break;
            }
