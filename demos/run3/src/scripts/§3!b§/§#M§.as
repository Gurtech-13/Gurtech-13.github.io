   ...
   public class §#M§ extends §+Z§
   {
      ...
      override public function init() : void
      {
         ...
         if(!_loc8_)
         {
            ...
            while(_loc1_ < int(_loc2_.length))
            {
               ...
               _loc4_ = new §^s§(§9_§,§'O§.§&!#§[int(_loc3_.id)],_loc3_.fade,_loc3_.alpha,null,§7!6§.spritesheet);
               while(true)
               {
                  if(!_loc8_)
                  {
      ...
      public function §-!P§(param1:int) : void
      {
         ...
         while(true)
         {
            ...
            {
               tunnel.§<!M§.§6!&§(Number(_loc5_.cameraPosition.x),Number(_loc5_.cameraPosition.y),Number(_loc5_.cameraPosition.z));
               if(_loc18_)
               {
                  break;
               }
                                          ...
                                          while(true)
                                          {
                                             ...
                                             if(!_loc18_)
                                             {
                                                ...
                                                else
                                                {
                                                   ...
                                                   {
                                                      addr04fe:
                                                      _loc12_.§9E§(_loc11_.x,_loc11_.z,false,_loc11_.y);
                                                   }
                                                   addr0513:
                                                   while(true)
                                                   {
