package §3!b§
{
   ...
   public class LightningStrikesTwice extends §+Z§
   {
      ...
      public function frame0() : void
      {
         ...
         box.reset();
         box.transform.§"I§(§4!R§.§1!A§(0,-0.14279966607226333,0));
            ...
            while(true)
            {
               if(_loc3_)
               {
                  ...
                  while(true)
                  {
                     if(_loc3_)
                     {
                        §4!R§.§1!A§(3.141592653589793,3.141592653589793,0.031415926535897934,tunnel.§<!M§.§,t§);
                        tunnel.§<!M§.reset();
                        if(!_loc3_)
                        {
                           break;
                        }
                        tunnel.§<!M§.§6!&§(0,-150,2300);
                        if(_loc4_)
                        {
                           break loop1;
                        }
