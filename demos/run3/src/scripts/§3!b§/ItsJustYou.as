   ...
   public class ItsJustYou extends §+Z§
   {
      ...
      public function frame5() : void
      {
         ...
         while(true)
         {
            ...
            lizard.§9E§(2.9,-18.4,true,-60);
            if(!_loc1_)
            {
               lizard.transform.rotate(§4!R§.§1!A§(0,1.5707963267948966,0));
            }
            break;
         }
      }
         ...
         while(true)
         {
            if(_loc2_)
            {
               ...
               while(true)
               {
                  ...
                  lizard.§9E§(3.2,-18.4,true,-20);
                  if(!_loc3_)
                  {
                     lizard.transform.rotate(§4!R§.§1!A§(0,1.0471975511965976,0));
                     if(_loc2_)
                     {
                        break;
                     }
