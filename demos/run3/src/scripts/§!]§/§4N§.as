package §!]§
{
   ...
   public class §4N§ extends §[k§ implements §3!!§, §@[§
   {
      ...
      public static function §@!A§() : §4N§
      {
         §§push(false);
         var _loc2_:Boolean = true;
         var _loc3_:* = §§pop();
         var _loc1_:* = null as §4N§;
         if(_loc2_)
         {
            if(§4N§.instance != null)
            {
            ...
            while(true)
            {
               ...
               if(§§pop() >= int(_loc8_.length))
               {
                  ...
                  if(!_loc21_)
                  {
                     ...
                     _loc7_.§;3§(_loc3_,null,§4N§.§;!D§);
                     addr06c2:
                     §;!,§(_loc3_,_loc7_.levels,§4N§.§;!D§.x,§4N§.§;!D§.y);
                     addr06df:
                     return;
                  }
                  break loop16;
                  ...
                  while(true)
                  {
                     while(true)
                     {
                        if(!_loc21_)
                        {
                           ...
                           _loc9_.§>7§(_loc1_,_loc2_,null,§4N§.§1]§);
                        }
                        §§push(_loc1_ - §4N§.§1]§.x);
                        if(!_loc21_)
                        {
      ...
      override public function §^g§() : void
      {
         ...
         var _loc20_:Vector.<§6O§> = §'O§.available;
         if(!_loc25_)
         {
