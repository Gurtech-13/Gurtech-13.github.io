package §%!Q§
{
   ...
   import §3!b§.FriendlyGreeting;
   import §3!b§.Indecision;
   import §3!b§.ItsJustYou;
   import §3!b§.MyTurn;
   import §3!b§.StandardsToUphold;
      ...
      public function §&r§()
      {
         ...
         if(!_loc52_)
         {
            ...
            while(true)
            {
               if(_loc51_)
               {
                  §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§>-§,3,1,-2200,null,{
                     "backwards":true,
               ...
               §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§0x§,34,null,null,null,{"beginMessage":"Step 2: gather the others.\nStep 3: FINALLY go home."}));
               if(_loc51_)
               {
                  break;
               }
            }
            §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§>=§,6,null,null,null,{"beginMessage":"Missing tiles. Someone was here recently!"}));
         }
         var _loc2_:§6O§ = §'O§.§#!P§;
         var _loc3_:§ !>§ = §>K§.§2s§;
         ...
         while(true)
         {
            ...
            §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§,[§,7,null,null,null,{"beginMessage":"Does he WANT to stay out here?\nBut there\'s nothing here! I don\'t get it..."}));
            if(_loc51_)
            {
               break;
            }
            ...
            while(true)
            {
               ...
               §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§0x§,32,null,null,null,{
                  "backwards":true,
            ...
            while(true)
            {
               ...
               §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§7&§,1,null,null,null,{
                  "noCrumblingTiles":true,
            ...
            if(!_loc52_)
            {
               ...
               if(!_loc52_)
               {
                  new §"v§(§'O§.lizard,"The Lizard",_loc27_);
                  while(true)
                  {
                     if(!_loc52_)
                     {
            ...
            §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§>y§,6,null,null,null,{"beginMessage":"Just a few more places left to check."}));
            §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§`!5§,7));
            §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§`!5§,0,null,null,null,{
               "backwards":true,
               "startTilesLength":§&r§.§#!8§,
            ...
            if(!_loc52_)
            {
               §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§>y§,9,1,-2000,null,{"beginMessage":"Gotta check here just to be sure..."}));
               §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§>y§,9,2,null,null,{
                  "backwards":true,
                  "startTilesLength":-1,
            ...
            while(true)
            {
               while(true)
               {
                  if(!_loc52_)
                  {
                     ...
                     §+!@§.push(new §"v§(§'O§.skater,"The Show-off",_loc5_));
                     if(_loc51_)
                     {
                        §+!@§.push(new §"v§(§'O§.duplicator,"The Crackpot",_loc9_));
                        §+!@§.push(new §"v§(§'O§.student,"The Nerd",_loc32_));
                        if(_loc52_)
                        {
                           continue loop18;
                        }
                  ...
                  §+!@§.push(new §"v§(§'O§.child,"The Sneak",null,§^!I§(§'O§.duplicator)));
                  continue loop18;
               }
               §§push(0);
               if(!_loc52_)
            ...
            §+!@§.push(new §"v§(§'O§.pastafarian,"The Meddler",_loc13_));
            §+!@§.push(new §"v§(§'O§.gentleman,"The Snob",_loc23_));
            loop18:
            while(true)
            {
               while(true)
         ...
         §;I§.push(new §'!]§(§'O§.§#!P§,§>K§.§,[§,9,1,-2500,null,{
