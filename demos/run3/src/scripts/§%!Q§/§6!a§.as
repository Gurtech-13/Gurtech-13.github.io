package §%!Q§
{
   ...
   import §3!b§.MorningHypothesis;
   import §3!b§.MorningHypothesis2;
   import §3!b§.MorningHypothesis3;
   import §3!b§.MorningHypothesis4;
   import §3!b§.MorningHypothesis5;
   import §3!b§.Revision;
   import §3!b§.TwoMonthWait;
   import §3!b§.TwoMonthWait2;
   import §3!b§.TwoMonthWait3;
   import §4n§.§>!,§;
   ...
   public class §6!a§ extends §>!,§ implements §+<§
   {
      ...
      public function §6!a§()
      {
         ...
         while(true)
         {
            ...
            §=! §(0,function(param1:§<!§, param2:§ !W§, param3:int):JumpInstructionsTrigger
            {
         ...
         while(true)
         {
            ...
            §=! §(357,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
            {
         ...
         if(_loc3_)
         {
            ...
            if(_loc3_)
            {
               §=! §(174,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
               {
                  return new BeatLevelAndSave(param1,param2,param3);
               },new §<!§(function():void
               {
         ...
         if(_loc3_)
         {
            ...
            if(_loc3_)
            {
               §=! §(321,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
               {
                  return new BeatLevelAndSave(param1,param2,param3);
               },new §<!§(function():void
               {
         ...
         while(true)
         {
            ...
            §=! §(405,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
            {
               return new BeatLevelAndSave(param1,param2,param3);
            },new §<!§(function():void
            {
         ...
         while(true)
         {
            ...
            §=! §(344,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
            {
               return new BeatLevelAndSave(param1,param2,param3);
            },new §<!§(function():void
            {
         ...
         while(true)
         {
            ...
            §=! §(338,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
            {
               return new BeatLevelAndSave(param1,param2,param3);
            },new §<!§(function():void
            {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc2_)
            {
               §=! §(269,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
               {
                  return new BeatLevelAndSave(param1,param2,param3);
               },new §<!§(function():void
               {
         ...
         if(_loc3_)
         {
            ...
            if(!_loc2_)
            {
               §=! §(340,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
               {
                  return new BeatLevelAndSave(param1,param2,param3);
               },new §<!§(function():void
               {
         ...
         if(!_loc2_)
         {
            ...
            if(!_loc2_)
            {
               §=! §(346,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
               {
                  return new BeatLevelAndSave(param1,param2,param3);
               },new §<!§(function():void
               {
         ...
         while(true)
         {
            if(!_loc2_)
            {
               ...
               if(!_loc2_)
               {
                  §=! §(131,function(param1:§<!§, param2:§ !W§, param3:int):NoJumpingOrAbilities
                  {
               ...
               §=! §(269,function(param1:§<!§, param2:§ !W§, param3:int):ModulateSound
               {
            ...
            §=! §(188,function(param1:§<!§, param2:§ !W§, param3:int):WormholeBehavior
            {
      ...
      override public function §-@§(param1:Achievement, param2:Object = undefined, param3:§6O§ = undefined) : void
      {
         §§push(false);
