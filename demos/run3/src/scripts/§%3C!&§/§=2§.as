package §<!&§
{
   ...
   public class §=2§ implements §>N§
   {
      ...
      public function §=2§(param1:§1![§, param2:Number, param3:Number = 0.017)
      {
         §§push(false);
      ...
      public function §`g§(param1:§%!§, param2:§%!§) : int
      {
         §§push(false);
         var _loc3_:Boolean = true;
         var _loc4_:* = §§pop();
      ...
      public function §1%§(param1:Point3D, param2:Point3D, param3:§]!Q§, param4:Point3D = undefined, param5:Object = undefined, param6:Object = undefined, param7:§"B§ = undefined) : §%!§
      {
         §§push(false);
                                       ...
                                       while(true)
                                       {
                                          ...
                                          while(true)
                                          {
                                             ...
                                             while(true)
                                             {
                                                ...
                                                _loc14_.§1%§(param1,param2,param5,param6,§=2§.§1]§,_loc8_);
                                                §§push(Number(§=2§.§1]§.x));
                                                if(!_loc24_)
                                                {
                                                   _loc19_ = §§pop();
