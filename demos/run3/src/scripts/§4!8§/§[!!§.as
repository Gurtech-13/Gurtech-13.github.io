package §4!8§
{
   ...
   public class §[!!§ implements §+<§
   {
      ...
      public function §,!M§(param1:Object) : void
      {
         ...
         {
            §6!a§.§@!A§().§=! §(param1.level,function(param1:§<!§, param2:§ !W§, param3:int):BeatLevelAndSave
            {
      ...
      public function §#,§(param1:Object) : void
      {
         ...
         while(true)
         {
            ...
            while(true)
            {
               while(true)
               {
                  ...
                  §§push(param1.character < int(§'O§.§&!#§.length));
                  if(_loc13_)
                  {
                     break loop3;
                  }
         ...
         addr0087:
         var _loc2_:§6O§ = §'O§.§&!#§[int(param1.character)];
         if(!_loc14_)
         {
            if(param1.id != null)
            {
